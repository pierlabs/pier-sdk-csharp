...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PacoteTarifaPersist :  IEquatable<PacoteTarifaPersist>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PacoteTarifaPersist" /> class.
        /// Initializes a new instance of the <see cref="PacoteTarifaPersist" />class.
        /// </summary>
        ...
        public PacoteTarifaPersist(string Descricao = null, int? QuantidadeRecargaCelular = null, int? QuantidadeBilheteUnico = null, int? QuantidadeTaxaPagamentoConta = null, int? QuantidadeSaque = null, int? QuantidadeTransferencia = null, int? QuantidadeBoleto = null, int? QuantidadeAplicacoes = null, double? ValorTarifa = null)
        {
            // to ensure "QuantidadeRecargaCelular" is required (not null)
            if (QuantidadeRecargaCelular == null)
            {
                throw new InvalidDataException("QuantidadeRecargaCelular is a required property for PacoteTarifaPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("QuantidadeBilheteUnico is a required property for PacoteTarifaPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("QuantidadeTaxaPagamentoConta is a required property for PacoteTarifaPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("QuantidadeSaque is a required property for PacoteTarifaPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("QuantidadeTransferencia is a required property for PacoteTarifaPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("QuantidadeBoleto is a required property for PacoteTarifaPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("QuantidadeAplicacoes is a required property for PacoteTarifaPersist and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PacoteTarifaPersist);
        }

        /// <summary>
        /// Returns true if PacoteTarifaPersist instances are equal
        /// </summary>
        /// <param name="other">Instance of PacoteTarifaPersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PacoteTarifaPersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

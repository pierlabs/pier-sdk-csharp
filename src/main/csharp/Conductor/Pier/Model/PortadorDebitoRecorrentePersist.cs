...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortadorDebitoRecorrentePersist :  IEquatable<PortadorDebitoRecorrentePersist>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PortadorDebitoRecorrentePersist" /> class.
        /// Initializes a new instance of the <see cref="PortadorDebitoRecorrentePersist" />class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PortadorDebitoRecorrentePersist);
        }

        /// <summary>
        /// Returns true if PortadorDebitoRecorrentePersist instances are equal
        /// </summary>
        /// <param name="other">Instance of PortadorDebitoRecorrentePersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PortadorDebitoRecorrentePersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

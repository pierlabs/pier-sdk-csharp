...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagePlataformaMobileResponse :  IEquatable<PagePlataformaMobileResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePlataformaMobileResponse" /> class.
        /// Initializes a new instance of the <see cref="PagePlataformaMobileResponse" />class.
        /// </summary>
        ...
        public List<PlataformaMobileResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PagePlataformaMobileResponse);
        }

        /// <summary>
        /// Returns true if PagePlataformaMobileResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PagePlataformaMobileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagePlataformaMobileResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

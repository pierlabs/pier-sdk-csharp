...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <param name="ChaveCriptograma">{{{cartao_pay_atualizar_chave_response_chave_criptograma_value}}}.</param>
        ...
        /// </summary>
        /// <value>{{{cartao_pay_atualizar_chave_response_chave_criptograma_value}}}</value>

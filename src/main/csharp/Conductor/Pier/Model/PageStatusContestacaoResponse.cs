...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageStatusContestacaoResponse :  IEquatable<PageStatusContestacaoResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageStatusContestacaoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageStatusContestacaoResponse" />class.
        /// </summary>
        ...
        public List<StatusContestacaoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageStatusContestacaoResponse);
        }

        /// <summary>
        /// Returns true if PageStatusContestacaoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageStatusContestacaoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageStatusContestacaoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageCampoCodificadoDescricaoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageCampoCodificadoDescricaoResponse" />class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageCampoCodificadoDescricaoResponse);
        }

        /// <summary>
        /// Returns true if PageCampoCodificadoDescricaoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageCampoCodificadoDescricaoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageCampoCodificadoDescricaoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

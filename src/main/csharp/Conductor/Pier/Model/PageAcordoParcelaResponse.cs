...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageAcordoParcelaResponse :  IEquatable<PageAcordoParcelaResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageAcordoParcelaResponse" /> class.
        /// Initializes a new instance of the <see cref="PageAcordoParcelaResponse" />class.
        /// </summary>
        ...
        public List<ParcelaAcordoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageAcordoParcelaResponse);
        }

        /// <summary>
        /// Returns true if PageAcordoParcelaResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageAcordoParcelaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageAcordoParcelaResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

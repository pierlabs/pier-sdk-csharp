...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageConfiguracaoRotativoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageConfiguracaoRotativoResponse" />class.
        /// </summary>
        ...
        public List<ConfiguracaoRotativoDetalheResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageConfiguracaoRotativoResponse);
        }

        /// <summary>
        /// Returns true if PageConfiguracaoRotativoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageConfiguracaoRotativoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageConfiguracaoRotativoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageOperacaoCredorResponse :  IEquatable<PageOperacaoCredorResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageOperacaoCredorResponse" /> class.
        /// Initializes a new instance of the <see cref="PageOperacaoCredorResponse" />class.
        /// </summary>
        ...
        public List<OperacaoCredorResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageOperacaoCredorResponse);
        }

        /// <summary>
        /// Returns true if PageOperacaoCredorResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageOperacaoCredorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageOperacaoCredorResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

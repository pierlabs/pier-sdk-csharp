...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageEnderecoResponse :  IEquatable<PageEnderecoResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageEnderecoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageEnderecoResponse" />class.
        /// </summary>
        ...
        public List<EnderecoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageEnderecoResponse);
        }

        /// <summary>
        /// Returns true if PageEnderecoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageEnderecoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageEnderecoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

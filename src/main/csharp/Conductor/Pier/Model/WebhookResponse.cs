...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <param name="Metodo">M\u00E9todo que a ser chamado pelo WebHook.</param>
        /// <param name="Url">URL que a ser consumida pelo WebHook.</param>
        /// <param name="Status">Status do WebHook.</param>
        /// <param name="Headers">Headers do Webhook.</param>

        public WebhookResponse(long? Id = null, TipoEventoEnum? TipoEvento = null, MetodoEnum? Metodo = null, string Url = null, StatusEnum? Status = null, List<WebhookHeaderResponse> Headers = null)
        {
            this.Id = Id;
        ...
        /// Headers do Webhook
        /// </summary>
        /// <value>Headers do Webhook</value>
        [DataMember(Name="headers", EmitDefaultValue=false)]
        public List<WebhookHeaderResponse> Headers { get; set; }

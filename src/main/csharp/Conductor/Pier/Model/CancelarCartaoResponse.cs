...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CancelarCartaoResponse :  IEquatable<CancelarCartaoResponse>
    { 
        ...
        public CancelarCartaoResponse(int? CodigoRetorno = null, string DescricaoRetorno = null, int? IdCartao = null, int? IdConta = null)
        {
        ...
        /// </summary>
        /// <param name="other">Instance of CancelarCartaoResponse to be compared</param>
        /// <returns>Boolean</returns>

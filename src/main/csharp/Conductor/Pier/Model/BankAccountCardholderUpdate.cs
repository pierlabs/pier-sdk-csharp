...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BankAccountCardholderUpdate :  IEquatable<BankAccountCardholderUpdate>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="BankAccountCardholderUpdate" /> class.
        /// Initializes a new instance of the <see cref="BankAccountCardholderUpdate" />class.
        /// </summary>
        ...
        /// <param name="NumeroConta">Number of the account (required).</param>
        /// <param name="DigitoConta">Account digit.</param>
        /// <param name="FlagAtivo">Signal whether the bank account is active or not: (1: Atcive, 0: Inactive) (required).</param>
        /// <param name="FlagContaOrigemDoc">Signal if the origin is DOC (1: DOC, 0: TED) (required).</param>
        /// <param name="FlagContaPoupanca">Signal if the account is a saving account (1: Saving Account, 0: Current Account) (required).</param>
        /// <param name="Favorecido">Favored name (required).</param>
        /// <param name="NumeroReceiraFederal">Document of the favored (required).</param>
        /// <param name="Titularidade">Owner of the account (1:Cardholder is the owner, 0: Cardholder is not the owner.).</param>

        public BankAccountCardholderUpdate(string NomeAgencia = null, long? Banco = null, string NumeroAgencia = null, string DigitoAgencia = null, string NumeroConta = null, string DigitoConta = null, int? FlagAtivo = null, int? FlagContaOrigemDoc = null, int? FlagContaPoupanca = null, string Favorecido = null, string NumeroReceiraFederal = null, int? Titularidade = null)
        {
            // to ensure "Banco" is required (not null)
            if (Banco == null)
            {
                throw new InvalidDataException("Banco is a required property for BankAccountCardholderUpdate and cannot be null");
            }
            else
            {
                this.Banco = Banco;
            ...
            {
                throw new InvalidDataException("NumeroAgencia is a required property for BankAccountCardholderUpdate and cannot be null");
            }
            else
            {
            ...
            if (NumeroConta == null)
            {
                throw new InvalidDataException("NumeroConta is a required property for BankAccountCardholderUpdate and cannot be null");
            }
            else
            {
            ...
            if (FlagAtivo == null)
            {
                throw new InvalidDataException("FlagAtivo is a required property for BankAccountCardholderUpdate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("FlagContaOrigemDoc is a required property for BankAccountCardholderUpdate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("FlagContaPoupanca is a required property for BankAccountCardholderUpdate and cannot be null");
            }
            else
            {
            ...
            if (Favorecido == null)
            {
                throw new InvalidDataException("Favorecido is a required property for BankAccountCardholderUpdate and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NumeroReceiraFederal is a required property for BankAccountCardholderUpdate and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Signal whether the bank account is active or not: (1: Atcive, 0: Inactive)</value>
        ...
        /// </summary>
        /// <value>Signal if the account is a saving account (1: Saving Account, 0: Current Account)</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BankAccountCardholderUpdate);
        }

        /// <summary>
        /// Returns true if BankAccountCardholderUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of BankAccountCardholderUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BankAccountCardholderUpdate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

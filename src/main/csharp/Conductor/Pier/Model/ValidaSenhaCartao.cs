...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ValidaSenhaCartao :  IEquatable<ValidaSenhaCartao>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidaSenhaCartao" /> class.
        /// Initializes a new instance of the <see cref="ValidaSenhaCartao" />class.
        /// </summary>
        ...
        public ValidaSenhaCartao(string Mensagem = null, long? IdStatusCartao = null, string StatusCartao = null, int? QuantidadeTentativas = null, int? QuantidadeMaximaTentativas = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ValidaSenhaCartao);
        }

        /// <summary>
        /// Returns true if ValidaSenhaCartao instances are equal
        /// </summary>
        /// <param name="other">Instance of ValidaSenhaCartao to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValidaSenhaCartao other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

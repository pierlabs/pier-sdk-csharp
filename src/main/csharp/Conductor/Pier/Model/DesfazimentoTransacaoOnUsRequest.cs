...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <param name="DataHoraTransacaoCancelada">List the date and local time of the transactionto be canceled yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ. Ex: 2000-10-31T01:30:00.000-05:00 (required).</param>
        ...
        public DesfazimentoTransacaoOnUsRequest(string NsuOrigem = null, string NsuOrigemTransacaoCancelada = null, string CodigoProcessamento = null, string DataHoraTransacaoCancelada = null, double? ValorTransacao = null, string NumeroRealCartao = null, string DataValidadeCartao = null, long? NumeroEstabelecimento = null, string DataHoraTerminal = null, string TerminalRequisitante = null)
        {
            ...
            if (NsuOrigem == null)
            {
                throw new InvalidDataException("NsuOrigem is a required property for DesfazimentoTransacaoOnUsRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NsuOrigemTransacaoCancelada is a required property for DesfazimentoTransacaoOnUsRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CodigoProcessamento is a required property for DesfazimentoTransacaoOnUsRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DataHoraTransacaoCancelada is a required property for DesfazimentoTransacaoOnUsRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ValorTransacao is a required property for DesfazimentoTransacaoOnUsRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NumeroRealCartao is a required property for DesfazimentoTransacaoOnUsRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DataValidadeCartao is a required property for DesfazimentoTransacaoOnUsRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NumeroEstabelecimento is a required property for DesfazimentoTransacaoOnUsRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DataHoraTerminal is a required property for DesfazimentoTransacaoOnUsRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TerminalRequisitante is a required property for DesfazimentoTransacaoOnUsRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>List the date and local time of the transactionto be canceled yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ. Ex: 2000-10-31T01:30:00.000-05:00</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DesfazimentoTransacaoOnUsRequest);
        }

        /// <summary>
        /// Returns true if DesfazimentoTransacaoOnUsRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of DesfazimentoTransacaoOnUsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DesfazimentoTransacaoOnUsRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

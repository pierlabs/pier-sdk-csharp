...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContaBancariaPortadorUpdateValue :  IEquatable<ContaBancariaPortadorUpdateValue>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ContaBancariaPortadorUpdateValue" /> class.
        /// Initializes a new instance of the <see cref="ContaBancariaPortadorUpdateValue" />class.
        /// </summary>
        /// <param name="NomeAgencia">{{{conta_bancaria_portador_update_nome_agencia_value}}}.</param>
        /// <param name="Banco">{{{conta_bancaria_portador_update_banco_value}}} (required).</param>
        /// <param name="NumeroAgencia">{{{conta_bancaria_portador_update_numero_agencia_value}}} (required).</param>
        /// <param name="DigitoAgencia">{{{conta_bancaria_portador_update_digito_agencia_value}}}.</param>
        /// <param name="NumeroConta">{{{conta_bancaria_portador_update_numero_conta_value}}} (required).</param>
        /// <param name="DigitoConta">{{{conta_bancaria_portador_update_digito_conta_value}}}.</param>
        /// <param name="FlagAtivo">{{{conta_bancaria_portador_update_flag_ativo_value}}} (required).</param>
        /// <param name="FlagContaOrigemDoc">{{{conta_bancaria_portador_update_flag_conta_origem_doc_value}}} (required).</param>
        /// <param name="FlagContaPoupanca">{{{conta_bancaria_portador_update_flag_conta_poupanca_value}}} (required).</param>
        /// <param name="Favorecido">{{{conta_bancaria_portador_update_favorecido_value}}} (required).</param>
        /// <param name="NumeroReceiraFederal">{{{conta_bancaria_portador_update_numero_receira_federal_value}}} (required).</param>
        /// <param name="Titularidade">{{{conta_bancaria_portador_update_titularidade_value}}}.</param>

        public ContaBancariaPortadorUpdateValue(string NomeAgencia = null, long? Banco = null, string NumeroAgencia = null, string DigitoAgencia = null, string NumeroConta = null, string DigitoConta = null, int? FlagAtivo = null, int? FlagContaOrigemDoc = null, int? FlagContaPoupanca = null, string Favorecido = null, string NumeroReceiraFederal = null, int? Titularidade = null)
        {
            // to ensure "Banco" is required (not null)
            if (Banco == null)
            {
                throw new InvalidDataException("Banco is a required property for ContaBancariaPortadorUpdateValue and cannot be null");
            }
            else
            {
                this.Banco = Banco;
            ...
            {
                throw new InvalidDataException("NumeroAgencia is a required property for ContaBancariaPortadorUpdateValue and cannot be null");
            }
            else
            {
            ...
            if (NumeroConta == null)
            {
                throw new InvalidDataException("NumeroConta is a required property for ContaBancariaPortadorUpdateValue and cannot be null");
            }
            else
            {
            ...
            if (FlagAtivo == null)
            {
                throw new InvalidDataException("FlagAtivo is a required property for ContaBancariaPortadorUpdateValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("FlagContaOrigemDoc is a required property for ContaBancariaPortadorUpdateValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("FlagContaPoupanca is a required property for ContaBancariaPortadorUpdateValue and cannot be null");
            }
            else
            {
            ...
            if (Favorecido == null)
            {
                throw new InvalidDataException("Favorecido is a required property for ContaBancariaPortadorUpdateValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NumeroReceiraFederal is a required property for ContaBancariaPortadorUpdateValue and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_nome_agencia_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_banco_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_numero_agencia_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_digito_agencia_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_numero_conta_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_digito_conta_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_flag_ativo_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_flag_conta_origem_doc_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_flag_conta_poupanca_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_favorecido_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_numero_receira_federal_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{conta_bancaria_portador_update_titularidade_value}}}</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContaBancariaPortadorUpdateValue);
        }

        /// <summary>
        /// Returns true if ContaBancariaPortadorUpdateValue instances are equal
        /// </summary>
        /// <param name="other">Instance of ContaBancariaPortadorUpdateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContaBancariaPortadorUpdateValue other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

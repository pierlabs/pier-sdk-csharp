...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageOrigensComerciais :  IEquatable<PageOrigensComerciais>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageOrigensComerciais" /> class.
        /// Initializes a new instance of the <see cref="PageOrigensComerciais" />class.
        /// </summary>
        ...
        public List<OrigemComercial> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageOrigensComerciais);
        }

        /// <summary>
        /// Returns true if PageOrigensComerciais instances are equal
        /// </summary>
        /// <param name="other">Instance of PageOrigensComerciais to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageOrigensComerciais other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

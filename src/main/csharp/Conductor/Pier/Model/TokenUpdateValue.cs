...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenUpdateValue :  IEquatable<TokenUpdateValue>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenUpdateValue" /> class.
        /// Initializes a new instance of the <see cref="TokenUpdateValue" />class.
        /// </summary>
        ...
        public TokenUpdateValue(long? _Base = null, string Owner = null, string CriadoPor = null, string AlteradoPor = null, long? IdAplicacao = null)
        {
            ...
            if (CriadoPor == null)
            {
                throw new InvalidDataException("CriadoPor is a required property for TokenUpdateValue and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TokenUpdateValue);
        }

        /// <summary>
        /// Returns true if TokenUpdateValue instances are equal
        /// </summary>
        /// <param name="other">Instance of TokenUpdateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenUpdateValue other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageTransferenciaBancariaResponse :  IEquatable<PageTransferenciaBancariaResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageTransferenciaBancariaResponse" /> class.
        /// Initializes a new instance of the <see cref="PageTransferenciaBancariaResponse" />class.
        /// </summary>
        ...
        public List<TransferenciaBancariaResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageTransferenciaBancariaResponse);
        }

        /// <summary>
        /// Returns true if PageTransferenciaBancariaResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageTransferenciaBancariaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageTransferenciaBancariaResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LogAcessoUsuario :  IEquatable<LogAcessoUsuario>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LogAcessoUsuario" /> class.
        /// Initializes a new instance of the <see cref="LogAcessoUsuario" />class.
        /// </summary>
        /// <param name="IdUsuario">Unique user identifier (id) (required).</param>
        /// <param name="Login">User login (required).</param>
        /// <param name="Mensagem">Log message.</param>
        /// <param name="VersaoAPP">Application version.</param>
        /// <param name="Device">Disposition operation.</param>
        /// <param name="SenhaOK">Passaword status.</param>
        /// <param name="TentativasIncorretas">Number of incorrect attemps.</param>
        /// <param name="IdPlataforma">Unique platform identifier (id).</param>
        /// <param name="Status">User status.</param>

        public LogAcessoUsuario(long? IdUsuario = null, string Login = null, string Mensagem = null, string VersaoAPP = null, string Device = null, int? SenhaOK = null, long? TentativasIncorretas = null, long? IdPlataforma = null, StatusEnum? Status = null)
        {
            // to ensure "IdUsuario" is required (not null)
            if (IdUsuario == null)
            {
                throw new InvalidDataException("IdUsuario is a required property for LogAcessoUsuario and cannot be null");
            }
            else
            {
            ...
            if (Login == null)
            {
                throw new InvalidDataException("Login is a required property for LogAcessoUsuario and cannot be null");
            }
            else
            {
                this.Login = Login;
        ...
        /// </summary>
        /// <value>Unique user identifier (id)</value>
        ...
        /// </summary>
        /// <value>Disposition operation</value>
        ...
        /// </summary>
        /// <value>Number of incorrect attemps</value>
        ...
        /// </summary>
        /// <value>Unique platform identifier (id)</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LogAcessoUsuario);
        }

        /// <summary>
        /// Returns true if LogAcessoUsuario instances are equal
        /// </summary>
        /// <param name="other">Instance of LogAcessoUsuario to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogAcessoUsuario other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SegurancaMobilePersist :  IEquatable<SegurancaMobilePersist>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SegurancaMobilePersist" /> class.
        /// Initializes a new instance of the <see cref="SegurancaMobilePersist" />class.
        /// </summary>
        /// <param name="StatusRequisicao">Status da requisi\u00E7\u00E3o/solicita\u00E7\u00E3o do token (required).</param>
        /// <param name="CpfCnpj">CNPJ ou CPF da pessoa (required).</param>
        /// <param name="DataExpiracao">Data da expira\u00E7\u00E3o do token (required).</param>
        ...
        public SegurancaMobilePersist(StatusRequisicaoEnum? StatusRequisicao = null, string CpfCnpj = null, string DataExpiracao = null, string Token = null, string Tablet = null, string DeviceName = null, string DeviceToken = null, string Canal = null, string DataUtilizacao = null, string DataAtivacao = null, string ChapaPromotor = null, string CodOperacaoNeurotech = null, string RespostaNeurotech = null)
        {
            ...
            if (CpfCnpj == null)
            {
                throw new InvalidDataException("CpfCnpj is a required property for SegurancaMobilePersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DataExpiracao is a required property for SegurancaMobilePersist and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SegurancaMobilePersist);
        }

        /// <summary>
        /// Returns true if SegurancaMobilePersist instances are equal
        /// </summary>
        /// <param name="other">Instance of SegurancaMobilePersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SegurancaMobilePersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

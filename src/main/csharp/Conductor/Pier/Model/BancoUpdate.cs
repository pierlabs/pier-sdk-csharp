...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BancoUpdate :  IEquatable<BancoUpdate>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="BancoUpdate" /> class.
        /// Initializes a new instance of the <see cref="BancoUpdate" />class.
        /// </summary>
        ...
        public BancoUpdate(string Nome = null, string Descricao = null, string DigitoBanco = null, string Ispb = null, string Cnpj = null, bool? FlagAtivoBacen = null)
        {
            this.Nome = Nome;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BancoUpdate);
        }

        /// <summary>
        /// Returns true if BancoUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of BancoUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BancoUpdate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenCartaoPersist :  IEquatable<TokenCartaoPersist>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenCartaoPersist" /> class.
        /// Initializes a new instance of the <see cref="TokenCartaoPersist" />class.
        /// </summary>
        ...
        /// <param name="DataAtualizacaoChaveDispositivo">Data de atualiza\u00E7\u00E3o da chave do dispositivo (required).</param>

        public TokenCartaoPersist(string Token = null, string RequestorID = null, string ReferenceID = null, string PanReferenceID = null, string Tipo = null, StatusEnum? Status = null, UltimoStatusEnum? UltimoStatus = null, string CodigoAtivacao = null, int? TentativasAtivacao = null, int? QtdCodigosAtivacao = null, int? Score = null, string ResultadoAprovisionamento = null, string Validade = null, string DataAtualizacaoChaveDispositivo = null)
        {
            // to ensure "DataAtualizacaoChaveDispositivo" is required (not null)
            if (DataAtualizacaoChaveDispositivo == null)
            {
                throw new InvalidDataException("DataAtualizacaoChaveDispositivo is a required property for TokenCartaoPersist and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TokenCartaoPersist);
        }

        /// <summary>
        /// Returns true if TokenCartaoPersist instances are equal
        /// </summary>
        /// <param name="other">Instance of TokenCartaoPersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenCartaoPersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

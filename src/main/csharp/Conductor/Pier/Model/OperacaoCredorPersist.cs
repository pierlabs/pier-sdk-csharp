...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <param name="IdsProduto">Show the list of ids products that will have register rules (required).</param>
        ...
        /// </summary>
        /// <value>Show the list of ids products that will have register rules</value>

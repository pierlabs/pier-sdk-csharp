...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageSMSResponse" /> class.
        /// Initializes a new instance of the <see cref="PageSMSResponse" />class.
        /// </summary>
        ...
        public List<NotificacaoSMSResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageSMSResponse);
        }

        /// <summary>
        /// Returns true if PageSMSResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageSMSResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageSMSResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

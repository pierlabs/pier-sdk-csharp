...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <param name="DataVencimentoParcelaAcordo">Data e Hora do vencimento da parcela do acordo.</param>
        /// <param name="Status">C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Status do Pagamento.</param>

        public HistoricoPagamentoResponse(long? IdConta = null, long? IdPagamento = null, long? IdEstabelecimento = null, long? IdBanco = null, long? IdCartao = null, double? ValorPagamento = null, string DataHoraPagamento = null, string DataHoraEntradaPagamento = null, string DataVencimentoParcelaAcordo = null, long? Status = null)
        {
        ...
        /// </summary>
        /// <value>Data e Hora do vencimento da parcela do acordo</value>
        [DataMember(Name="dataVencimentoParcelaAcordo", EmitDefaultValue=false)]
        public string DataVencimentoParcelaAcordo { get; set; }
        ...
        public bool Equals(HistoricoPagamentoResponse other)
        {
            ...
            return 
                ...
                (
                    this.DataVencimentoParcelaAcordo == other.DataVencimentoParcelaAcordo ||
                    this.DataVencimentoParcelaAcordo != null &&
                    this.DataVencimentoParcelaAcordo.Equals(other.DataVencimentoParcelaAcordo)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DataVencimentoParcelaAcordo != null)
                    hash = hash * 59 + this.DataVencimentoParcelaAcordo.GetHashCode();

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageTelefones :  IEquatable<PageTelefones>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageTelefones" /> class.
        /// Initializes a new instance of the <see cref="PageTelefones" />class.
        /// </summary>
        ...
        public List<Telefone> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageTelefones);
        }

        /// <summary>
        /// Returns true if PageTelefones instances are equal
        /// </summary>
        /// <param name="other">Instance of PageTelefones to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageTelefones other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContaDebitoTarifaUpdate :  IEquatable<ContaDebitoTarifaUpdate>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ContaDebitoTarifaUpdate" /> class.
        /// Initializes a new instance of the <see cref="ContaDebitoTarifaUpdate" />class.
        /// </summary>
        ...
        public ContaDebitoTarifaUpdate(double? Valor = null, double? ValorOriginal = null, double? PercentualDesconto = null, string DataHoraFimCobranca = null, string DataHoraExpiracao = null)
        {
            this.Valor = Valor;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContaDebitoTarifaUpdate);
        }

        /// <summary>
        /// Returns true if ContaDebitoTarifaUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of ContaDebitoTarifaUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContaDebitoTarifaUpdate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

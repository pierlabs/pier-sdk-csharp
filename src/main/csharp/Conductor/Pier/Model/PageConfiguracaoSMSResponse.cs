...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageConfiguracaoSMSResponse :  IEquatable<PageConfiguracaoSMSResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageConfiguracaoSMSResponse" /> class.
        /// Initializes a new instance of the <see cref="PageConfiguracaoSMSResponse" />class.
        /// </summary>
        ...
        public List<ConfiguracaoSMSResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageConfiguracaoSMSResponse);
        }

        /// <summary>
        /// Returns true if PageConfiguracaoSMSResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageConfiguracaoSMSResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageConfiguracaoSMSResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

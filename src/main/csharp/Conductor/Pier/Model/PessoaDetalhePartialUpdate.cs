...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PessoaDetalhePartialUpdate :  IEquatable<PessoaDetalhePartialUpdate>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PessoaDetalhePartialUpdate" /> class.
        /// Initializes a new instance of the <see cref="PessoaDetalhePartialUpdate" />class.
        /// </summary>
        ...
        /// <param name="NomeEmpresa">Nome da empresa do cliente.</param>
        ...
        /// </summary>
        /// <value>Nome da empresa do cliente</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PessoaDetalhePartialUpdate);
        }

        /// <summary>
        /// Returns true if PessoaDetalhePartialUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of PessoaDetalhePartialUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PessoaDetalhePartialUpdate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

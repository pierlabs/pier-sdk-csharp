...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CartaoPayConfirmarChaveResponse :  IEquatable<CartaoPayConfirmarChaveResponse>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CartaoPayConfirmarChaveResponse" /> class.
        /// Initializes a new instance of the <see cref="CartaoPayConfirmarChaveResponse" />class.
        /// </summary>
        ...
        /// <param name="DataValidadeChaveCriptograma">{{{cartao_pay_response_data_validade_chave_criptograma_value}}}.</param>
        /// <param name="ChaveCriptograma">{{{cartao_pay_confirmar_chave_response_chave_criptograma_value}}}.</param>

        public CartaoPayConfirmarChaveResponse(long? Id = null, string NumeroCartao = null, string DataValidadeCartao = null, string NomeImpresso = null, long? IdEntidade = null, string NomeEntidade = null, StatusEnum? Status = null, string DataValidadeChaveCriptograma = null, string ChaveCriptograma = null)
        {
            this.Id = Id;
        ...
        /// </summary>
        /// <value>{{{cartao_pay_response_data_validade_chave_criptograma_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{cartao_pay_confirmar_chave_response_chave_criptograma_value}}}</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CartaoPayConfirmarChaveResponse);
        }

        /// <summary>
        /// Returns true if CartaoPayConfirmarChaveResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CartaoPayConfirmarChaveResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CartaoPayConfirmarChaveResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

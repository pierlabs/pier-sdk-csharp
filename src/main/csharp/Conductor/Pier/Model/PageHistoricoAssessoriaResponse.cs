...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageHistoricoAssessoriaResponse :  IEquatable<PageHistoricoAssessoriaResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageHistoricoAssessoriaResponse" /> class.
        /// Initializes a new instance of the <see cref="PageHistoricoAssessoriaResponse" />class.
        /// </summary>
        ...
        public List<HistoricoAssessoriaResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageHistoricoAssessoriaResponse);
        }

        /// <summary>
        /// Returns true if PageHistoricoAssessoriaResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageHistoricoAssessoriaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageHistoricoAssessoriaResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

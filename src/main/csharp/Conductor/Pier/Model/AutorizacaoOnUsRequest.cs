...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <param name="NumeroParcelas">Number of Portions (required).</param>
        /// <param name="CodigoProcessamento">Code of Processing that identifies the Type of Transaction (required).</param>
        /// <param name="CodigoSegurancaCartao">Safety Code of the Card.</param>
        ...
        /// Number of Portions
        /// </summary>
        /// <value>Number of Portions</value>
        ...
        /// </summary>
        /// <value>Safety Code of the Card</value>

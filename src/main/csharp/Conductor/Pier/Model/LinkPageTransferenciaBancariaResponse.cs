...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinkPageTransferenciaBancariaResponse :  IEquatable<LinkPageTransferenciaBancariaResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkPageTransferenciaBancariaResponse" /> class.
        /// Initializes a new instance of the <see cref="LinkPageTransferenciaBancariaResponse" />class.
        /// </summary>
        ...
        public List<LinkTransferenciaBancariaResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LinkPageTransferenciaBancariaResponse);
        }

        /// <summary>
        /// Returns true if LinkPageTransferenciaBancariaResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of LinkPageTransferenciaBancariaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkPageTransferenciaBancariaResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

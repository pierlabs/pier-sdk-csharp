...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageServicoContaResponse :  IEquatable<PageServicoContaResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageServicoContaResponse" /> class.
        /// Initializes a new instance of the <see cref="PageServicoContaResponse" />class.
        /// </summary>
        ...
        public List<ServicoContaResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageServicoContaResponse);
        }

        /// <summary>
        /// Returns true if PageServicoContaResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageServicoContaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageServicoContaResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

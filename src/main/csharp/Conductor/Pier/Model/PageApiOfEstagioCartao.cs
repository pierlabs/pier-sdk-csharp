...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageApiOfEstagioCartao :  IEquatable<PageApiOfEstagioCartao>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageApiOfEstagioCartao" /> class.
        /// Initializes a new instance of the <see cref="PageApiOfEstagioCartao" />class.
        /// </summary>
        ...
        public List<EstagioCartao> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageApiOfEstagioCartao);
        }

        /// <summary>
        /// Returns true if PageApiOfEstagioCartao instances are equal
        /// </summary>
        /// <param name="other">Instance of PageApiOfEstagioCartao to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageApiOfEstagioCartao other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

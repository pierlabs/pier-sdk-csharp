...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LogRequisicaoMobilePartialUpdate :  IEquatable<LogRequisicaoMobilePartialUpdate>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="LogRequisicaoMobilePartialUpdate" /> class.
        /// Initializes a new instance of the <see cref="LogRequisicaoMobilePartialUpdate" />class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LogRequisicaoMobilePartialUpdate);
        }

        /// <summary>
        /// Returns true if LogRequisicaoMobilePartialUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of LogRequisicaoMobilePartialUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogRequisicaoMobilePartialUpdate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

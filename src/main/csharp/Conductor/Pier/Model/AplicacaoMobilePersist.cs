...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AplicacaoMobilePersist :  IEquatable<AplicacaoMobilePersist>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AplicacaoMobilePersist" /> class.
        /// Initializes a new instance of the <see cref="AplicacaoMobilePersist" />class.
        /// </summary>
        ...
        public AplicacaoMobilePersist(long? IdPlataformaMobile = null, long? IdEmissor = null, string Token = null, string Cor = null, string Som = null, string Icone = null, string CertificadoBase64 = null, string Senha = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AplicacaoMobilePersist);
        }

        /// <summary>
        /// Returns true if AplicacaoMobilePersist instances are equal
        /// </summary>
        /// <param name="other">Instance of AplicacaoMobilePersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AplicacaoMobilePersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

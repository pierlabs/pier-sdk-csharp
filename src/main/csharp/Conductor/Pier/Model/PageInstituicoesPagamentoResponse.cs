...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageInstituicoesPagamentoResponse :  IEquatable<PageInstituicoesPagamentoResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageInstituicoesPagamentoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageInstituicoesPagamentoResponse" />class.
        /// </summary>
        ...
        public List<InstituicaoPagamentoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageInstituicoesPagamentoResponse);
        }

        /// <summary>
        /// Returns true if PageInstituicoesPagamentoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageInstituicoesPagamentoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageInstituicoesPagamentoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

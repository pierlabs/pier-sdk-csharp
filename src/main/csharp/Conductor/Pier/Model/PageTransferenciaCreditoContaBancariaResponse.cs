...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageTransferenciaCreditoContaBancariaResponse" /> class.
        /// Initializes a new instance of the <see cref="PageTransferenciaCreditoContaBancariaResponse" />class.
        /// </summary>
        ...
        public List<TransferenciaCreditoContaBancariaListaResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageTransferenciaCreditoContaBancariaResponse);
        }

        /// <summary>
        /// Returns true if PageTransferenciaCreditoContaBancariaResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageTransferenciaCreditoContaBancariaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageTransferenciaCreditoContaBancariaResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

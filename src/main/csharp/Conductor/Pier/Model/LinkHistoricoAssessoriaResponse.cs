...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LinkHistoricoAssessoriaResponse :  IEquatable<LinkHistoricoAssessoriaResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkHistoricoAssessoriaResponse" /> class.
        /// Initializes a new instance of the <see cref="LinkHistoricoAssessoriaResponse" />class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LinkHistoricoAssessoriaResponse);
        }

        /// <summary>
        /// Returns true if LinkHistoricoAssessoriaResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of LinkHistoricoAssessoriaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkHistoricoAssessoriaResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

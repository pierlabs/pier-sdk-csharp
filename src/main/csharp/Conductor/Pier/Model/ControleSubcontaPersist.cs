...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ControleSubcontaPersist :  IEquatable<ControleSubcontaPersist>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ControleSubcontaPersist" /> class.
        /// Initializes a new instance of the <see cref="ControleSubcontaPersist" />class.
        /// </summary>
        ...
        public ControleSubcontaPersist(string Nome = null, string Finalidade = null, bool? AutoGerenciavel = null)
        {
            this.Nome = Nome;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ControleSubcontaPersist);
        }

        /// <summary>
        /// Returns true if ControleSubcontaPersist instances are equal
        /// </summary>
        /// <param name="other">Instance of ControleSubcontaPersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ControleSubcontaPersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

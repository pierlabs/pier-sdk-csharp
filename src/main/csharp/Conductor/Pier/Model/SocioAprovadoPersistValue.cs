...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SocioAprovadoPersistValue :  IEquatable<SocioAprovadoPersistValue>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="SocioAprovadoPersistValue" /> class.
        /// Initializes a new instance of the <see cref="SocioAprovadoPersistValue" />class.
        /// </summary>
        /// <param name="Nome">{{{socio_aprovado_persist_nome_value}}} (required).</param>
        /// <param name="Cpf">{{{socio_aprovado_persist_cpf_value}}}.</param>
        /// <param name="DataNascimento">{{{socio_aprovado_persist_data_nascimento_value}}}.</param>
        /// <param name="Sexo">{{{socio_aprovado_persist_sexo_value}}}.</param>
        /// <param name="NumeroIdentidade">{{{socio_aprovado_persist_numero_identidade_value}}}.</param>
        /// <param name="OrgaoExpedidorIdentidade">{{{socio_aprovado_persist_orgao_expedidor_identidade_value}}}.</param>
        /// <param name="UnidadeFederativaIdentidade">{{{socio_aprovado_persist_unidade_federativa_identidade_value}}}.</param>
        /// <param name="DataEmissaoIdentidade">{{{socio_aprovado_persist_data_emissao_identidade_value}}}.</param>
        /// <param name="EstadoCivil">{{{socio_aprovado_persist_estado_civil_value}}}.</param>
        /// <param name="Profissao">{{{socio_aprovado_persist_profissao_value}}}.</param>
        /// <param name="Nacionalidade">{{{socio_aprovado_persist_nacionalidade_value}}}.</param>
        /// <param name="Email">{{{socio_aprovado_persist_email_value}}}.</param>
        /// <param name="Telefones">{{{socio_aprovado_persist_telefones_value}}}.</param>

        public SocioAprovadoPersistValue(string Nome = null, string Cpf = null, string DataNascimento = null, string Sexo = null, string NumeroIdentidade = null, string OrgaoExpedidorIdentidade = null, string UnidadeFederativaIdentidade = null, string DataEmissaoIdentidade = null, string EstadoCivil = null, string Profissao = null, string Nacionalidade = null, string Email = null, List<TelefonePessoaAprovadaPersistValue> Telefones = null)
        {
            // to ensure "Nome" is required (not null)
            if (Nome == null)
            {
                throw new InvalidDataException("Nome is a required property for SocioAprovadoPersistValue and cannot be null");
            }
            else
            {
                this.Nome = Nome;
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_nome_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_cpf_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_data_nascimento_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_sexo_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_numero_identidade_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_orgao_expedidor_identidade_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_unidade_federativa_identidade_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_data_emissao_identidade_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_estado_civil_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_profissao_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_nacionalidade_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_email_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{socio_aprovado_persist_telefones_value}}}</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SocioAprovadoPersistValue);
        }

        /// <summary>
        /// Returns true if SocioAprovadoPersistValue instances are equal
        /// </summary>
        /// <param name="other">Instance of SocioAprovadoPersistValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SocioAprovadoPersistValue other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

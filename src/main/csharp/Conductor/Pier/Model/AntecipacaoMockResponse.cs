...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AntecipacaoMockResponse :  IEquatable<AntecipacaoMockResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="AntecipacaoMockResponse" /> class.
        /// Initializes a new instance of the <see cref="AntecipacaoMockResponse" />class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AntecipacaoMockResponse);
        }

        /// <summary>
        /// Returns true if AntecipacaoMockResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of AntecipacaoMockResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AntecipacaoMockResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

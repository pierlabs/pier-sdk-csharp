...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageLoteCartaoResponse :  IEquatable<PageLoteCartaoResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageLoteCartaoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageLoteCartaoResponse" />class.
        /// </summary>
        ...
        public List<LoteCartaoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageLoteCartaoResponse);
        }

        /// <summary>
        /// Returns true if PageLoteCartaoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageLoteCartaoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageLoteCartaoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

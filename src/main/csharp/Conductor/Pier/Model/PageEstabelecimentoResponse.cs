...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageEstabelecimentoResponse :  IEquatable<PageEstabelecimentoResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageEstabelecimentoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageEstabelecimentoResponse" />class.
        /// </summary>
        ...
        public List<EstabelecimentoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageEstabelecimentoResponse);
        }

        /// <summary>
        /// Returns true if PageEstabelecimentoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageEstabelecimentoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageEstabelecimentoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

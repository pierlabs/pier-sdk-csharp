...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageControleCartaoGrupoMCCResponse :  IEquatable<PageControleCartaoGrupoMCCResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageControleCartaoGrupoMCCResponse" /> class.
        /// Initializes a new instance of the <see cref="PageControleCartaoGrupoMCCResponse" />class.
        /// </summary>
        ...
        public List<ControleCartaoGrupoMCCResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageControleCartaoGrupoMCCResponse);
        }

        /// <summary>
        /// Returns true if PageControleCartaoGrupoMCCResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageControleCartaoGrupoMCCResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageControleCartaoGrupoMCCResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

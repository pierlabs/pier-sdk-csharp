...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageControleSegurancaDispositivoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageControleSegurancaDispositivoResponse" />class.
        /// </summary>
        ...
        public List<ControleSegurancaDispositivoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageControleSegurancaDispositivoResponse);
        }

        /// <summary>
        /// Returns true if PageControleSegurancaDispositivoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageControleSegurancaDispositivoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageControleSegurancaDispositivoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

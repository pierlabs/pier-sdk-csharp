...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HistoricoTelefone :  IEquatable<HistoricoTelefone>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricoTelefone" /> class.
        /// Initializes a new instance of the <see cref="HistoricoTelefone" />class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as HistoricoTelefone);
        }

        /// <summary>
        /// Returns true if HistoricoTelefone instances are equal
        /// </summary>
        /// <param name="other">Instance of HistoricoTelefone to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoricoTelefone other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

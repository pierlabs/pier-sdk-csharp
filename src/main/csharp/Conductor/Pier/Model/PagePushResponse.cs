...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePushResponse" /> class.
        /// Initializes a new instance of the <see cref="PagePushResponse" />class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PagePushResponse);
        }

        /// <summary>
        /// Returns true if PagePushResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PagePushResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagePushResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

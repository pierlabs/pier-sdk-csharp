...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BasePartialUpdateValue :  IEquatable<BasePartialUpdateValue>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="BasePartialUpdateValue" /> class.
        /// Initializes a new instance of the <see cref="BasePartialUpdateValue" />class.
        /// </summary>
        /// <param name="Servidor">{{{base_partial_update_servidor_value}}} (required).</param>
        /// <param name="Usuario">{{{base_partial_update_usuario_value}}} (required).</param>
        /// <param name="Senha">{{{base_partial_update_senha_value}}} (required).</param>
        /// <param name="NomeBase">{{{base_partial_update_nome_base_value}}} (required).</param>
        /// <param name="AlteradoPor">{{{base_partial_update_alterado_por_value}}} (required).</param>
        /// <param name="Domain">{{{base_partial_update_domain_value}}}.</param>
        /// <param name="SenhaCriptografada">{{{base_partial_update_senha_criptografada_value}}} (required).</param>
        /// <param name="NomeBaseControleAcesso">{{{base_partial_update_nome_base_controle_acesso_value}}} (required).</param>
        /// <param name="IdEmissor">{{{base_partial_update_id_emissor_value}}}.</param>
        /// <param name="ServidorControleAcesso">{{{base_partial_update_servidor_controle_acesso_value}}} (required).</param>
        /// <param name="NomeBaseUsuarios">{{{base_partial_update_nome_base_usuarios_value}}} (required).</param>
        /// <param name="ServidorUsuarios">{{{base_partial_update_servidor_usuarios_value}}} (required).</param>
        /// <param name="FlagCluster">{{{base_partial_update_flag_cluster_value}}} (required).</param>

        public BasePartialUpdateValue(string Servidor = null, string Usuario = null, string Senha = null, string NomeBase = null, string AlteradoPor = null, string Domain = null, bool? SenhaCriptografada = null, string NomeBaseControleAcesso = null, long? IdEmissor = null, string ServidorControleAcesso = null, string NomeBaseUsuarios = null, string ServidorUsuarios = null, bool? FlagCluster = null)
        {
            // to ensure "Servidor" is required (not null)
            if (Servidor == null)
            {
                throw new InvalidDataException("Servidor is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
            ...
            if (Usuario == null)
            {
                throw new InvalidDataException("Usuario is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
            ...
            if (Senha == null)
            {
                throw new InvalidDataException("Senha is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
                this.Senha = Senha;
            ...
            if (NomeBase == null)
            {
                throw new InvalidDataException("NomeBase is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
            ...
            if (AlteradoPor == null)
            {
                throw new InvalidDataException("AlteradoPor is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("SenhaCriptografada is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NomeBaseControleAcesso is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ServidorControleAcesso is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NomeBaseUsuarios is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ServidorUsuarios is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
            ...
            if (FlagCluster == null)
            {
                throw new InvalidDataException("FlagCluster is a required property for BasePartialUpdateValue and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>{{{base_partial_update_servidor_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_usuario_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_senha_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_nome_base_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_alterado_por_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_domain_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_senha_criptografada_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_nome_base_controle_acesso_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_id_emissor_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_servidor_controle_acesso_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_nome_base_usuarios_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_servidor_usuarios_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{base_partial_update_flag_cluster_value}}}</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BasePartialUpdateValue);
        }

        /// <summary>
        /// Returns true if BasePartialUpdateValue instances are equal
        /// </summary>
        /// <param name="other">Instance of BasePartialUpdateValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BasePartialUpdateValue other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

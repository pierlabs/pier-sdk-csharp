...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SuspeitaFraudeUpdate :  IEquatable<SuspeitaFraudeUpdate>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="SuspeitaFraudeUpdate" /> class.
        /// Initializes a new instance of the <see cref="SuspeitaFraudeUpdate" />class.
        /// </summary>
        ...
        public SuspeitaFraudeUpdate(long? IdMotivoFraude = null, long? IdPessoa = null, string DataHoraSuspeitaFraude = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SuspeitaFraudeUpdate);
        }

        /// <summary>
        /// Returns true if SuspeitaFraudeUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of SuspeitaFraudeUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SuspeitaFraudeUpdate other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

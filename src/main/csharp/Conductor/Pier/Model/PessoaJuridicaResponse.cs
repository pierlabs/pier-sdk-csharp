...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// Initializes a new instance of the <see cref="PessoaJuridicaResponse" />class.
        /// </summary>
        /// <param name="Id">Id legal person.</param>
        /// <param name="Contato">Legal person contact.</param>
        /// <param name="RazaoSocial">Legal person corporate name.</param>
        /// <param name="NumeroReceitaFederal">CGC (CNPJ) legal person.</param>
        /// <param name="InscricaoEstadual">Legal person state registration.</param>
        /// <param name="Banco">Bank of the legal person.</param>
        /// <param name="Agencia">Agency of the legal person.</param>

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ParametroAcumuladorContaOperacaoPersist :  IEquatable<ParametroAcumuladorContaOperacaoPersist>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ParametroAcumuladorContaOperacaoPersist" /> class.
        /// Initializes a new instance of the <see cref="ParametroAcumuladorContaOperacaoPersist" />class.
        /// </summary>
        ...
        public ParametroAcumuladorContaOperacaoPersist(int? QtdOperacoesGratuitasDia = null, int? QtdOperacoesGratuitasSemana = null, int? QtdOperacoesGratuitasMes = null, double? ValorTAC = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ParametroAcumuladorContaOperacaoPersist);
        }

        /// <summary>
        /// Returns true if ParametroAcumuladorContaOperacaoPersist instances are equal
        /// </summary>
        /// <param name="other">Instance of ParametroAcumuladorContaOperacaoPersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParametroAcumuladorContaOperacaoPersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageTaxasRefinanciamento :  IEquatable<PageTaxasRefinanciamento>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageTaxasRefinanciamento" /> class.
        /// Initializes a new instance of the <see cref="PageTaxasRefinanciamento" />class.
        /// </summary>
        ...
        public List<TaxasRefinanciamento> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageTaxasRefinanciamento);
        }

        /// <summary>
        /// Returns true if PageTaxasRefinanciamento instances are equal
        /// </summary>
        /// <param name="other">Instance of PageTaxasRefinanciamento to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageTaxasRefinanciamento other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

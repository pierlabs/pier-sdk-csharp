...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <param name="Cvv">{{{cartao_pay_cadastro_response_cvv_value}}}.</param>
        /// <param name="ChaveCriptograma">{{{cartao_pay_cadastro_response_chave_criptograma_value}}}.</param>
        ...
        /// </summary>
        /// <value>{{{cartao_pay_cadastro_response_cvv_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{cartao_pay_cadastro_response_chave_criptograma_value}}}</value>

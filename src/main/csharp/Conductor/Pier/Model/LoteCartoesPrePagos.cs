...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoteCartoesPrePagos :  IEquatable<LoteCartoesPrePagos>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="LoteCartoesPrePagos" /> class.
        /// Initializes a new instance of the <see cref="LoteCartoesPrePagos" />class.
        /// </summary>
        ...
        public LoteCartoesPrePagos(long? Id = null, long? IdOrigemComercial = null, long? IdProduto = null, long? IdTipoCartao = null, long? IdImagem = null, long? IdEndereco = null, int? Quantidade = null, DateTime? DataCadastro = null, string UsuarioCadastro = null, int? StatusProcessamento = null)
        {
            ...
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for LoteCartoesPrePagos and cannot be null");
            }
            else
            {
                this.Id = Id;
            ...
            {
                throw new InvalidDataException("IdOrigemComercial is a required property for LoteCartoesPrePagos and cannot be null");
            }
            else
            {
            ...
            if (IdProduto == null)
            {
                throw new InvalidDataException("IdProduto is a required property for LoteCartoesPrePagos and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IdTipoCartao is a required property for LoteCartoesPrePagos and cannot be null");
            }
            else
            {
            ...
            if (IdImagem == null)
            {
                throw new InvalidDataException("IdImagem is a required property for LoteCartoesPrePagos and cannot be null");
            }
            else
            {
            ...
            if (IdEndereco == null)
            {
                throw new InvalidDataException("IdEndereco is a required property for LoteCartoesPrePagos and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DataCadastro is a required property for LoteCartoesPrePagos and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("UsuarioCadastro is a required property for LoteCartoesPrePagos and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("StatusProcessamento is a required property for LoteCartoesPrePagos and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LoteCartoesPrePagos);
        }

        /// <summary>
        /// Returns true if LoteCartoesPrePagos instances are equal
        /// </summary>
        /// <param name="other">Instance of LoteCartoesPrePagos to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoteCartoesPrePagos other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

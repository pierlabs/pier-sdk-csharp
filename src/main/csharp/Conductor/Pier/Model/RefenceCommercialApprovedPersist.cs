...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RefenceCommercialApprovedPersist :  IEquatable<RefenceCommercialApprovedPersist>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="RefenceCommercialApprovedPersist" /> class.
        /// Initializes a new instance of the <see cref="RefenceCommercialApprovedPersist" />class.
        /// </summary>
        /// <param name="RazaoSocial">Show the full name of the social reason of the commercial reference (business name).</param>
        /// <param name="NomeContrato">Responsable name of the commercial reference.</param>
        /// <param name="Ddd">DDD.</param>
        /// <param name="Telefone">Phone Number.</param>
        /// <param name="Email">Email.</param>

        public RefenceCommercialApprovedPersist(string RazaoSocial = null, string NomeContrato = null, string Ddd = null, string Telefone = null, string Email = null)
        {
        ...
        /// </summary>
        /// <value>Responsable name of the commercial reference</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RefenceCommercialApprovedPersist);
        }

        /// <summary>
        /// Returns true if RefenceCommercialApprovedPersist instances are equal
        /// </summary>
        /// <param name="other">Instance of RefenceCommercialApprovedPersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefenceCommercialApprovedPersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

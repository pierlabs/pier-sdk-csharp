...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebhookPersist :  IEquatable<WebhookPersist>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPersist" /> class.
        /// Initializes a new instance of the <see cref="WebhookPersist" />class.
        /// </summary>
        ...
        public WebhookPersist(TipoEventoEnum? TipoEvento = null, string Url = null)
        {
            // to ensure "TipoEvento" is required (not null)
            if (TipoEvento == null)
            {
                throw new InvalidDataException("TipoEvento is a required property for WebhookPersist and cannot be null");
            }
            else
            {
            ...
            if (Url == null)
            {
                throw new InvalidDataException("Url is a required property for WebhookPersist and cannot be null");
            }
            else
            {
                this.Url = Url;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as WebhookPersist);
        }

        /// <summary>
        /// Returns true if WebhookPersist instances are equal
        /// </summary>
        /// <param name="other">Instance of WebhookPersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookPersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

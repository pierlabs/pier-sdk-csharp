...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <param name="PaisDescricao">Descri\u00E7\u00E3o do pa\u00EDs.</param>

        public AvisoViagemResponse(long? Id = null, long? IdCartao = null, string CodigoPais = null, string DataInicio = null, string DataFim = null, int? FlagAtivo = null, string PaisDescricao = null)
        {
            this.Id = Id;
        ...
        /// Descri\u00E7\u00E3o do pa\u00EDs
        /// </summary>
        /// <value>Descri\u00E7\u00E3o do pa\u00EDs</value>
        [DataMember(Name="paisDescricao", EmitDefaultValue=false)]
        ...
        public bool Equals(AvisoViagemResponse other)
        {
            ...
            return 
                ...
                (
                    this.PaisDescricao == other.PaisDescricao ||
                    this.PaisDescricao != null &&
                    this.PaisDescricao.Equals(other.PaisDescricao)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PaisDescricao != null)
                    hash = hash * 59 + this.PaisDescricao.GetHashCode();

...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageTaxasRefinanciamentoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageTaxasRefinanciamentoResponse" />class.
        /// </summary>
        ...
        public List<TaxasRefinanciamentoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageTaxasRefinanciamentoResponse);
        }

        /// <summary>
        /// Returns true if PageTaxasRefinanciamentoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageTaxasRefinanciamentoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageTaxasRefinanciamentoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

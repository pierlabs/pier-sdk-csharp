...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OportunidadePersistValue :  IEquatable<OportunidadePersistValue>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="OportunidadePersistValue" /> class.
        /// Initializes a new instance of the <see cref="OportunidadePersistValue" />class.
        /// </summary>
        /// <param name="IdTipoOportunidade">{{{oportunidade_persist_id_tipo_oportunidade_value}}} (required).</param>
        /// <param name="IdStatusOportunidade">{{{oportunidade_persist_id_status_oportunidade_value}}} (required).</param>
        /// <param name="NumeroReceitaFederal">{{{oportunidade_persist_numero_receita_federal_value}}} (required).</param>
        /// <param name="DataInicioVigencia">{{{oportunidade_persist_data_inicio_vigencia_value}}} (required).</param>
        /// <param name="DataFimVigencia">{{{oportunidade_persist_data_fim_vigencia_value}}} (required).</param>
        /// <param name="FlagAtivo">{{{oportunidade_persist_flag_ativo_value}}} (required).</param>
        /// <param name="Detalhes">{{{oportunidade_persist_detalhes_value}}} (required).</param>

        public OportunidadePersistValue(long? IdTipoOportunidade = null, long? IdStatusOportunidade = null, string NumeroReceitaFederal = null, string DataInicioVigencia = null, string DataFimVigencia = null, bool? FlagAtivo = null, List<DetalheOportunidadePersistValue> Detalhes = null)
        {
            // to ensure "IdTipoOportunidade" is required (not null)
            if (IdTipoOportunidade == null)
            {
                throw new InvalidDataException("IdTipoOportunidade is a required property for OportunidadePersistValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IdStatusOportunidade is a required property for OportunidadePersistValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NumeroReceitaFederal is a required property for OportunidadePersistValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DataInicioVigencia is a required property for OportunidadePersistValue and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DataFimVigencia is a required property for OportunidadePersistValue and cannot be null");
            }
            else
            {
            ...
            if (FlagAtivo == null)
            {
                throw new InvalidDataException("FlagAtivo is a required property for OportunidadePersistValue and cannot be null");
            }
            else
            {
            ...
            if (Detalhes == null)
            {
                throw new InvalidDataException("Detalhes is a required property for OportunidadePersistValue and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>{{{oportunidade_persist_id_tipo_oportunidade_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{oportunidade_persist_id_status_oportunidade_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{oportunidade_persist_numero_receita_federal_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{oportunidade_persist_data_inicio_vigencia_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{oportunidade_persist_data_fim_vigencia_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{oportunidade_persist_flag_ativo_value}}}</value>
        ...
        /// </summary>
        /// <value>{{{oportunidade_persist_detalhes_value}}}</value>
        [DataMember(Name="detalhes", EmitDefaultValue=false)]
        public List<DetalheOportunidadePersistValue> Detalhes { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OportunidadePersistValue);
        }

        /// <summary>
        /// Returns true if OportunidadePersistValue instances are equal
        /// </summary>
        /// <param name="other">Instance of OportunidadePersistValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OportunidadePersistValue other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

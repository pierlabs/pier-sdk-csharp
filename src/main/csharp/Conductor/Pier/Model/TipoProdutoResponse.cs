...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TipoProdutoResponse :  IEquatable<TipoProdutoResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="TipoProdutoResponse" /> class.
        /// Initializes a new instance of the <see cref="TipoProdutoResponse" />class.
        /// </summary>
        ...
        public TipoProdutoResponse(string Descricao = null, int? FlagAntecipacao = null, int? FlagConsignada = null, int? FlagCreditoBeneficio = null, int? FlagPrePago = null, long? Id = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TipoProdutoResponse);
        }

        /// <summary>
        /// Returns true if TipoProdutoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TipoProdutoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TipoProdutoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

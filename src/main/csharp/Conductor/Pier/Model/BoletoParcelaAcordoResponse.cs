...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// Initializes a new instance of the <see cref="BoletoParcelaAcordoResponse" />class.
        /// </summary>
        /// <param name="NumeroDocumento">Document number is the infor- mation code Document number is the code entered by the bank for customer identification by the bank for customer identification.</param>
        ...
        /// <param name="EspecieDocumento">Document type is the identifier of the type of bank slip (standard: &#39;DV&#39;).</param>
        ...
        /// </summary>
        /// <value>Document number is the infor- mation code Document number is the code entered by the bank for customer identification by the bank for customer identification</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BoletoParcelaAcordoResponse);
        }

        /// <summary>
        /// Returns true if BoletoParcelaAcordoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of BoletoParcelaAcordoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BoletoParcelaAcordoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.NumeroDocumento.Equals(other.NumeroDocumento)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NumeroDocumento != null)
                    hash = hash * 59 + this.NumeroDocumento.GetHashCode();

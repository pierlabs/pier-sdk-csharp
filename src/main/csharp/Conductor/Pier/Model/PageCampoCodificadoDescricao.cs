...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageCampoCodificadoDescricao :  IEquatable<PageCampoCodificadoDescricao>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageCampoCodificadoDescricao" /> class.
        /// Initializes a new instance of the <see cref="PageCampoCodificadoDescricao" />class.
        /// </summary>
        ...
        public List<CampoCodificadoDescricaoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageCampoCodificadoDescricao);
        }

        /// <summary>
        /// Returns true if PageCampoCodificadoDescricao instances are equal
        /// </summary>
        /// <param name="other">Instance of PageCampoCodificadoDescricao to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageCampoCodificadoDescricao other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

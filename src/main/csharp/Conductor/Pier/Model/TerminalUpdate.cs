...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// Initializes a new instance of the <see cref="TerminalUpdate" />class.
        /// </summary>
        /// <param name="FlagConsultaExtrato">Flag indicando se o terminal \u00C3\u00A9 f\u00C3\u00ADsico ou virtual, sendo: (true: Sim), (false: N\u00C3\u00A3o)). (required).</param>
        /// <param name="FlagTerminalVirtual">Flag indicando se o terminal permite consultar extrato, sendo: (true: Sim), (false: N\u00C3\u00A3o)). (required).</param>

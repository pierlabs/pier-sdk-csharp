...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageBancos :  IEquatable<PageBancos>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageBancos" /> class.
        /// Initializes a new instance of the <see cref="PageBancos" />class.
        /// </summary>
        ...
        public List<Banco> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageBancos);
        }

        /// <summary>
        /// Returns true if PageBancos instances are equal
        /// </summary>
        /// <param name="other">Instance of PageBancos to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageBancos other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

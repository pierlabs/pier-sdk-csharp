...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageContaDebitoTarifaResponse :  IEquatable<PageContaDebitoTarifaResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageContaDebitoTarifaResponse" /> class.
        /// Initializes a new instance of the <see cref="PageContaDebitoTarifaResponse" />class.
        /// </summary>
        ...
        public List<ContaDebitoTarifaResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageContaDebitoTarifaResponse);
        }

        /// <summary>
        /// Returns true if PageContaDebitoTarifaResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageContaDebitoTarifaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageContaDebitoTarifaResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

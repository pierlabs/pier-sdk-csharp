...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageTiposOperacoesResponse :  IEquatable<PageTiposOperacoesResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageTiposOperacoesResponse" /> class.
        /// Initializes a new instance of the <see cref="PageTiposOperacoesResponse" />class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageTiposOperacoesResponse);
        }

        /// <summary>
        /// Returns true if PageTiposOperacoesResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageTiposOperacoesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageTiposOperacoesResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

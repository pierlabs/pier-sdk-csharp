...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContaBancariaPortadorPersist :  IEquatable<ContaBancariaPortadorPersist>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ContaBancariaPortadorPersist" /> class.
        /// Initializes a new instance of the <see cref="ContaBancariaPortadorPersist" />class.
        /// </summary>
        /// <param name="IdConta">C\u00F3digo identificador da conta cart\u00E3o (required).</param>
        ...
        /// <param name="IdPessoaFisica">C\u00F3digo da pessoa (required).</param>
        ...
        public ContaBancariaPortadorPersist(long? IdConta = null, string NomeAgencia = null, long? Banco = null, string NumeroAgencia = null, string DigitoAgencia = null, string NumeroConta = null, string DigitoConta = null, int? FlagAtivo = null, int? FlagContaOrigemDoc = null, long? IdPessoaFisica = null, int? FlagContaPoupanca = null, string Favorecido = null, string NumeroReceiraFederal = null, int? Titularidade = null)
        {
            // to ensure "IdConta" is required (not null)
            if (IdConta == null)
            {
                throw new InvalidDataException("IdConta is a required property for ContaBancariaPortadorPersist and cannot be null");
            }
            else
            {
            ...
            if (Banco == null)
            {
                throw new InvalidDataException("Banco is a required property for ContaBancariaPortadorPersist and cannot be null");
            }
            else
            {
                this.Banco = Banco;
            ...
            {
                throw new InvalidDataException("NumeroAgencia is a required property for ContaBancariaPortadorPersist and cannot be null");
            }
            else
            {
            ...
            if (NumeroConta == null)
            {
                throw new InvalidDataException("NumeroConta is a required property for ContaBancariaPortadorPersist and cannot be null");
            }
            else
            {
            ...
            if (FlagAtivo == null)
            {
                throw new InvalidDataException("FlagAtivo is a required property for ContaBancariaPortadorPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("FlagContaOrigemDoc is a required property for ContaBancariaPortadorPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IdPessoaFisica is a required property for ContaBancariaPortadorPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("FlagContaPoupanca is a required property for ContaBancariaPortadorPersist and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>C\u00F3digo identificador da conta cart\u00E3o</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContaBancariaPortadorPersist);
        }

        /// <summary>
        /// Returns true if ContaBancariaPortadorPersist instances are equal
        /// </summary>
        /// <param name="other">Instance of ContaBancariaPortadorPersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContaBancariaPortadorPersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

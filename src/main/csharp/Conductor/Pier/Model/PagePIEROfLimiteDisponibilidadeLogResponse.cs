...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagePIEROfLimiteDisponibilidadeLogResponse :  IEquatable<PagePIEROfLimiteDisponibilidadeLogResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePIEROfLimiteDisponibilidadeLogResponse" /> class.
        /// Initializes a new instance of the <see cref="PagePIEROfLimiteDisponibilidadeLogResponse" />class.
        /// </summary>
        ...
        public List<LimiteDisponibilidadeLogResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PagePIEROfLimiteDisponibilidadeLogResponse);
        }

        /// <summary>
        /// Returns true if PagePIEROfLimiteDisponibilidadeLogResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PagePIEROfLimiteDisponibilidadeLogResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagePIEROfLimiteDisponibilidadeLogResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

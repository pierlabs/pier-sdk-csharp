...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TypeBillingPersist :  IEquatable<TypeBillingPersist>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="TypeBillingPersist" /> class.
        /// Initializes a new instance of the <see cref="TypeBillingPersist" />class.
        /// </summary>
        /// <param name="Descricao">Desciption of the billing type (required).</param>
        /// <param name="FlagApenasDemonstrativo">Flag that represents that the billing will be only demonstrative (required).</param>
        /// <param name="IdConvenio">Identification Code of the agreement related to the billing type.</param>

        public TypeBillingPersist(string Descricao = null, bool? FlagApenasDemonstrativo = null, long? IdConvenio = null)
        {
            // to ensure "Descricao" is required (not null)
            if (Descricao == null)
            {
                throw new InvalidDataException("Descricao is a required property for TypeBillingPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("FlagApenasDemonstrativo is a required property for TypeBillingPersist and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Desciption of the billing type</value>
        ...
        /// </summary>
        /// <value>Identification Code of the agreement related to the billing type</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TypeBillingPersist);
        }

        /// <summary>
        /// Returns true if TypeBillingPersist instances are equal
        /// </summary>
        /// <param name="other">Instance of TypeBillingPersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TypeBillingPersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

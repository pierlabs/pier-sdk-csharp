...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ParametroAcumuladorProdutoOperacaoPersist :  IEquatable<ParametroAcumuladorProdutoOperacaoPersist>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ParametroAcumuladorProdutoOperacaoPersist" /> class.
        /// Initializes a new instance of the <see cref="ParametroAcumuladorProdutoOperacaoPersist" />class.
        /// </summary>
        ...
        public ParametroAcumuladorProdutoOperacaoPersist(int? QtdMaxDia = null, int? QtdMaxSemana = null, int? QtdMaxMes = null, double? ValorMaxDia = null, double? ValorMaxSemana = null, double? ValorMaxMes = null, int? QtdOperacoesGratuitasDia = null, int? QtdOperacoesGratuitasSemana = null, int? QtdOperacoesGratuitasMes = null, double? ValorTAC = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ParametroAcumuladorProdutoOperacaoPersist);
        }

        /// <summary>
        /// Returns true if ParametroAcumuladorProdutoOperacaoPersist instances are equal
        /// </summary>
        /// <param name="other">Instance of ParametroAcumuladorProdutoOperacaoPersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParametroAcumuladorProdutoOperacaoPersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageCampanhaResponse :  IEquatable<PageCampanhaResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageCampanhaResponse" /> class.
        /// Initializes a new instance of the <see cref="PageCampanhaResponse" />class.
        /// </summary>
        ...
        public List<CampanhaResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageCampanhaResponse);
        }

        /// <summary>
        /// Returns true if PageCampanhaResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageCampanhaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageCampanhaResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

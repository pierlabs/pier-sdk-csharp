...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageStatusCartaoResponse :  IEquatable<PageStatusCartaoResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageStatusCartaoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageStatusCartaoResponse" />class.
        /// </summary>
        ...
        public List<StatusCartaoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageStatusCartaoResponse);
        }

        /// <summary>
        /// Returns true if PageStatusCartaoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageStatusCartaoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageStatusCartaoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

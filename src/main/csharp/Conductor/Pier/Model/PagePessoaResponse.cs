...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagePessoaResponse :  IEquatable<PagePessoaResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePessoaResponse" /> class.
        /// Initializes a new instance of the <see cref="PagePessoaResponse" />class.
        /// </summary>
        ...
        public List<PessoaResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PagePessoaResponse);
        }

        /// <summary>
        /// Returns true if PagePessoaResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PagePessoaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagePessoaResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

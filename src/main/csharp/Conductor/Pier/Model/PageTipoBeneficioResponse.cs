...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageTipoBeneficioResponse :  IEquatable<PageTipoBeneficioResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageTipoBeneficioResponse" /> class.
        /// Initializes a new instance of the <see cref="PageTipoBeneficioResponse" />class.
        /// </summary>
        ...
        public List<TipoBeneficioResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageTipoBeneficioResponse);
        }

        /// <summary>
        /// Returns true if PageTipoBeneficioResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageTipoBeneficioResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageTipoBeneficioResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

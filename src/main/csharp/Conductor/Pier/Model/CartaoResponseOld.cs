...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CartaoResponseOld :  IEquatable<CartaoResponseOld>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="CartaoResponseOld" /> class.
        /// Initializes a new instance of the <see cref="CartaoResponseOld" />class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CartaoResponseOld);
        }

        /// <summary>
        /// Returns true if CartaoResponseOld instances are equal
        /// </summary>
        /// <param name="other">Instance of CartaoResponseOld to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CartaoResponseOld other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageSegurancaMobileResponse :  IEquatable<PageSegurancaMobileResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageSegurancaMobileResponse" /> class.
        /// Initializes a new instance of the <see cref="PageSegurancaMobileResponse" />class.
        /// </summary>
        ...
        public List<SegurancaMobileResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageSegurancaMobileResponse);
        }

        /// <summary>
        /// Returns true if PageSegurancaMobileResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageSegurancaMobileResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageSegurancaMobileResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

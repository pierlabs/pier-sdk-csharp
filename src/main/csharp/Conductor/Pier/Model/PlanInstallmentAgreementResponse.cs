...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlanInstallmentAgreementResponse :  IEquatable<PlanInstallmentAgreementResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PlanInstallmentAgreementResponse" /> class.
        /// Initializes a new instance of the <see cref="PlanInstallmentAgreementResponse" />class.
        /// </summary>
        ...
        public List<PaymentAgreementAgreement> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PlanInstallmentAgreementResponse);
        }

        /// <summary>
        /// Returns true if PlanInstallmentAgreementResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PlanInstallmentAgreementResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlanInstallmentAgreementResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

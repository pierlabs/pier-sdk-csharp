...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ControleSegurancaDispositivoPersistencia :  IEquatable<ControleSegurancaDispositivoPersistencia>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="ControleSegurancaDispositivoPersistencia" /> class.
        /// Initializes a new instance of the <see cref="ControleSegurancaDispositivoPersistencia" />class.
        /// </summary>
        ...
        public ControleSegurancaDispositivoPersistencia(long? IdUsuario = null, string PhoneId = null)
        {
            // to ensure "IdUsuario" is required (not null)
            if (IdUsuario == null)
            {
                throw new InvalidDataException("IdUsuario is a required property for ControleSegurancaDispositivoPersistencia and cannot be null");
            }
            else
            {
            ...
            if (PhoneId == null)
            {
                throw new InvalidDataException("PhoneId is a required property for ControleSegurancaDispositivoPersistencia and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ControleSegurancaDispositivoPersistencia);
        }

        /// <summary>
        /// Returns true if ControleSegurancaDispositivoPersistencia instances are equal
        /// </summary>
        /// <param name="other">Instance of ControleSegurancaDispositivoPersistencia to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ControleSegurancaDispositivoPersistencia other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

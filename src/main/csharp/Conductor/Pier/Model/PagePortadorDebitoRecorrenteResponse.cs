...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PagePortadorDebitoRecorrenteResponse :  IEquatable<PagePortadorDebitoRecorrenteResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PagePortadorDebitoRecorrenteResponse" /> class.
        /// Initializes a new instance of the <see cref="PagePortadorDebitoRecorrenteResponse" />class.
        /// </summary>
        ...
        public List<PortadorDebitoRecorrenteResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PagePortadorDebitoRecorrenteResponse);
        }

        /// <summary>
        /// Returns true if PagePortadorDebitoRecorrenteResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PagePortadorDebitoRecorrenteResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagePortadorDebitoRecorrenteResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

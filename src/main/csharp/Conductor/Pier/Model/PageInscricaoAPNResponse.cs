...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageInscricaoAPNResponse" /> class.
        /// Initializes a new instance of the <see cref="PageInscricaoAPNResponse" />class.
        /// </summary>
        ...
        public List<InscricaoAPNResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageInscricaoAPNResponse);
        }

        /// <summary>
        /// Returns true if PageInscricaoAPNResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageInscricaoAPNResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageInscricaoAPNResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

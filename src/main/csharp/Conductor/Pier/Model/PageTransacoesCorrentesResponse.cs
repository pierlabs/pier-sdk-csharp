...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageTransacoesCorrentesResponse :  IEquatable<PageTransacoesCorrentesResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageTransacoesCorrentesResponse" /> class.
        /// Initializes a new instance of the <see cref="PageTransacoesCorrentesResponse" />class.
        /// </summary>
        ...
        public List<TransacoesCorrentesResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageTransacoesCorrentesResponse);
        }

        /// <summary>
        /// Returns true if PageTransacoesCorrentesResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageTransacoesCorrentesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageTransacoesCorrentesResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

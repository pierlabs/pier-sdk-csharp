...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <param name="DataInicioVigencia">In\u00EDcio da vig\u00EAncia da oportunidade (required).</param>
        /// <param name="DataFimVigencia">Fim da vig\u00EAncia da oportunidade (required).</param>

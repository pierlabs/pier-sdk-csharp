...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageTipoBoletoResponse :  IEquatable<PageTipoBoletoResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageTipoBoletoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageTipoBoletoResponse" />class.
        /// </summary>
        ...
        public List<TipoBoletoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageTipoBoletoResponse);
        }

        /// <summary>
        /// Returns true if PageTipoBoletoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageTipoBoletoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageTipoBoletoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

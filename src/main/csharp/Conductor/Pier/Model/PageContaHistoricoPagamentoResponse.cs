...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageContaHistoricoPagamentoResponse :  IEquatable<PageContaHistoricoPagamentoResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageContaHistoricoPagamentoResponse" /> class.
        /// Initializes a new instance of the <see cref="PageContaHistoricoPagamentoResponse" />class.
        /// </summary>
        ...
        public List<ContaHistoricoPagamentoResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageContaHistoricoPagamentoResponse);
        }

        /// <summary>
        /// Returns true if PageContaHistoricoPagamentoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageContaHistoricoPagamentoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageContaHistoricoPagamentoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PageStatusOprtunidadesAUD :  IEquatable<PageStatusOprtunidadesAUD>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="PageStatusOprtunidadesAUD" /> class.
        /// Initializes a new instance of the <see cref="PageStatusOprtunidadesAUD" />class.
        /// </summary>
        ...
        public List<StatusOportunidadeAUDResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageStatusOprtunidadesAUD);
        }

        /// <summary>
        /// Returns true if PageStatusOprtunidadesAUD instances are equal
        /// </summary>
        /// <param name="other">Instance of PageStatusOprtunidadesAUD to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageStatusOprtunidadesAUD other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

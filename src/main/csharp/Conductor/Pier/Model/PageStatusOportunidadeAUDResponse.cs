...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageStatusOportunidadeAUDResponse" /> class.
        /// Initializes a new instance of the <see cref="PageStatusOportunidadeAUDResponse" />class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageStatusOportunidadeAUDResponse);
        }

        /// <summary>
        /// Returns true if PageStatusOportunidadeAUDResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageStatusOportunidadeAUDResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageStatusOportunidadeAUDResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OpportunityPersist :  IEquatable<OpportunityPersist>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="OpportunityPersist" /> class.
        /// Initializes a new instance of the <see cref="OpportunityPersist" />class.
        /// </summary>
        ...
        /// <param name="DataInicioVigencia">Date of begnning the duration of the opportunity (required).</param>
        /// <param name="DataFimVigencia">Date of the end of the term of opportunity (required).</param>
        /// <param name="FlagAtivo">Attribute that indicates if the opportunity is active (required).</param>
        /// <param name="Detalhes">List of the details (required).</param>

        public OpportunityPersist(long? IdTipoOportunidade = null, long? IdStatusOportunidade = null, string NumeroReceitaFederal = null, string DataInicioVigencia = null, string DataFimVigencia = null, bool? FlagAtivo = null, List<DetailOpportunityPersist> Detalhes = null)
        {
            // to ensure "IdTipoOportunidade" is required (not null)
            if (IdTipoOportunidade == null)
            {
                throw new InvalidDataException("IdTipoOportunidade is a required property for OpportunityPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IdStatusOportunidade is a required property for OpportunityPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NumeroReceitaFederal is a required property for OpportunityPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DataInicioVigencia is a required property for OpportunityPersist and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DataFimVigencia is a required property for OpportunityPersist and cannot be null");
            }
            else
            {
            ...
            if (FlagAtivo == null)
            {
                throw new InvalidDataException("FlagAtivo is a required property for OpportunityPersist and cannot be null");
            }
            else
            {
            ...
            if (Detalhes == null)
            {
                throw new InvalidDataException("Detalhes is a required property for OpportunityPersist and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Date of begnning the duration of the opportunity</value>
        ...
        /// </summary>
        /// <value>Date of the end of the term of opportunity</value>
        ...
        /// List of the details
        /// </summary>
        /// <value>List of the details</value>
        [DataMember(Name="detalhes", EmitDefaultValue=false)]
        public List<DetailOpportunityPersist> Detalhes { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OpportunityPersist);
        }

        /// <summary>
        /// Returns true if OpportunityPersist instances are equal
        /// </summary>
        /// <param name="other">Instance of OpportunityPersist to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpportunityPersist other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PushFCMAndGCM :  IEquatable<PushFCMAndGCM>
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PushFCMAndGCM" /> class.
        /// Initializes a new instance of the <see cref="PushFCMAndGCM" />class.
        /// </summary>
        ...
        /// <param name="TokenServidor">Show the token of its Android application created by Google (required).</param>
        ...
        /// <param name="Cor">Show the icon color of the notification. This color must be informed in the format RGB Ex. #000000.</param>

        public PushFCMAndGCM(long? IdPessoa = null, long? IdConta = null, string TokenDispositivo = null, string TokenServidor = null, string Titulo = null, string Conteudo = null, TipoEventoEnum? TipoEvento = null, string Icone = null, string Som = null, string Cor = null)
        {
            // to ensure "IdPessoa" is required (not null)
            if (IdPessoa == null)
            {
                throw new InvalidDataException("IdPessoa is a required property for PushFCMAndGCM and cannot be null");
            }
            else
            {
            ...
            if (IdConta == null)
            {
                throw new InvalidDataException("IdConta is a required property for PushFCMAndGCM and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TokenDispositivo is a required property for PushFCMAndGCM and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TokenServidor is a required property for PushFCMAndGCM and cannot be null");
            }
            else
            {
            ...
            if (Titulo == null)
            {
                throw new InvalidDataException("Titulo is a required property for PushFCMAndGCM and cannot be null");
            }
            else
            {
                this.Titulo = Titulo;
            ...
            if (Conteudo == null)
            {
                throw new InvalidDataException("Conteudo is a required property for PushFCMAndGCM and cannot be null");
            }
            else
            {
            ...
            if (TipoEvento == null)
            {
                throw new InvalidDataException("TipoEvento is a required property for PushFCMAndGCM and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Show the token of its Android application created by Google</value>
        ...
        /// </summary>
        /// <value>Show the icon color of the notification. This color must be informed in the format RGB Ex. #000000</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PushFCMAndGCM);
        }

        /// <summary>
        /// Returns true if PushFCMAndGCM instances are equal
        /// </summary>
        /// <param name="other">Instance of PushFCMAndGCM to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushFCMAndGCM other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

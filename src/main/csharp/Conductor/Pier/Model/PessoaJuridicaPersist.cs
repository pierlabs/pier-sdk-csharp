...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <param name="RazaoSocial">{{{pessoa_juridica_persist_razao_social_value}}} (required).</param>
        /// <param name="NumeroReceitaFederal">{{{pessoa_juridica_persist_CGC_value}}} (required).</param>
        /// <param name="InscricaoEstadual">{{{pessoa_juridica_persist_inscricao_estadual_value}}}.</param>
        /// <param name="Banco">{{{pessoa_juridica_persist_banco_value}}} (required).</param>
        /// <param name="Agencia">{{{pessoa_juridica_persist_agencia_value}}} (required).</param>

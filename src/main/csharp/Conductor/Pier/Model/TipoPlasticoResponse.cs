...
namespace Conductor.Pier.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TipoPlasticoResponse :  IEquatable<TipoPlasticoResponse>
    { 
    
        /// <summary>
        /// Initializes a new instance of the <see cref="TipoPlasticoResponse" /> class.
        /// Initializes a new instance of the <see cref="TipoPlasticoResponse" />class.
        /// </summary>
        ...
        public TipoPlasticoResponse(bool? Bandeirado = null, string Fabrica = null, long? Id = null, long? IdEntidade = null, string Nome = null, string NomeArquivo = null, string TamanhoLinhas = null, double? ValorEmissao = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TipoPlasticoResponse);
        }

        /// <summary>
        /// Returns true if TipoPlasticoResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of TipoPlasticoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TipoPlasticoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

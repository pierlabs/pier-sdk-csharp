...
namespace Conductor.Pier.Model
{
    ...
    { 
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PageOrigemComercialResponse" /> class.
        /// Initializes a new instance of the <see cref="PageOrigemComercialResponse" />class.
        /// </summary>
        ...
        public List<OrigemComercialResponse> Content { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PageOrigemComercialResponse);
        }

        /// <summary>
        /// Returns true if PageOrigemComercialResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PageOrigemComercialResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageOrigemComercialResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;

...
namespace Conductor.Pier.Api
{
    ...
    public interface IBinApi
    {
        ...
        /// <param name="proximaConta">Bin proxima conta (optional)</param>
        /// <param name="flagCartaoVirtual">Bin flag cartao virtual (optional)</param>
        /// <param name="flagProvisorio">Bin flag provisorio (optional)</param>

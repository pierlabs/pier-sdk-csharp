...
namespace Conductor.Pier.Api
{
    ...
    /// </summary>
    public interface IGlobaltagstatuscontestacaoApi
    {
        ...
        /// <param name="flagAtivo">{{{status_contestacao_request_flagativo_value}}} (optional)</param>
        /// <returns>PageStatusContestacaoResponse</returns>
        PageStatusContestacaoResponse ListarStatusContestacaoUsingGET (List<string> sort = null, int? page = null, int? limit = null, long? idStatusContestacao = null, long? idStatusContestacaoOrigem = null, string descricao = null, int? flagPermiteAlteracao = null, int? flagSistema = null, int? flagAtivo = null);
        ...
        ApiResponse<PageStatusContestacaoResponse> ListarStatusContestacaoUsingGETWithHttpInfo (List<string> sort = null, int? page = null, int? limit = null, long? idStatusContestacao = null, long? idStatusContestacaoOrigem = null, string descricao = null, int? flagPermiteAlteracao = null, int? flagSistema = null, int? flagAtivo = null);
        ...
        System.Threading.Tasks.Task<PageStatusContestacaoResponse> ListarStatusContestacaoUsingGETAsync (List<string> sort = null, int? page = null, int? limit = null, long? idStatusContestacao = null, long? idStatusContestacaoOrigem = null, string descricao = null, int? flagPermiteAlteracao = null, int? flagSistema = null, int? flagAtivo = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class GlobaltagstatuscontestacaoApi : IGlobaltagstatuscontestacaoApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobaltagstatuscontestacaoApi"/> class.
        /// </summary>
        /// <returns></returns>
        public GlobaltagstatuscontestacaoApi(String basePath)
        {
        ...
        /// <returns></returns>
        public GlobaltagstatuscontestacaoApi(Configuration configuration = null)
        {
        ...
        /// <param name="flagAtivo">{{{status_contestacao_request_flagativo_value}}} (optional)</param> 
        /// <returns>PageStatusContestacaoResponse</returns>
        public PageStatusContestacaoResponse ListarStatusContestacaoUsingGET (List<string> sort = null, int? page = null, int? limit = null, long? idStatusContestacao = null, long? idStatusContestacaoOrigem = null, string descricao = null, int? flagPermiteAlteracao = null, int? flagSistema = null, int? flagAtivo = null)
        {
             ApiResponse<PageStatusContestacaoResponse> localVarResponse = ListarStatusContestacaoUsingGETWithHttpInfo(sort, page, limit, idStatusContestacao, idStatusContestacaoOrigem, descricao, flagPermiteAlteracao, flagSistema, flagAtivo);
        ...
        /// <param name="flagAtivo">{{{status_contestacao_request_flagativo_value}}} (optional)</param> 
        /// <returns>ApiResponse of PageStatusContestacaoResponse</returns>
        public ApiResponse< PageStatusContestacaoResponse > ListarStatusContestacaoUsingGETWithHttpInfo (List<string> sort = null, int? page = null, int? limit = null, long? idStatusContestacao = null, long? idStatusContestacaoOrigem = null, string descricao = null, int? flagPermiteAlteracao = null, int? flagSistema = null, int? flagAtivo = null)
        {
        ...
        /// <param name="flagAtivo">{{{status_contestacao_request_flagativo_value}}} (optional)</param>
        /// <returns>Task of PageStatusContestacaoResponse</returns>
        public async System.Threading.Tasks.Task<PageStatusContestacaoResponse> ListarStatusContestacaoUsingGETAsync (List<string> sort = null, int? page = null, int? limit = null, long? idStatusContestacao = null, long? idStatusContestacaoOrigem = null, string descricao = null, int? flagPermiteAlteracao = null, int? flagSistema = null, int? flagAtivo = null)
        {
             ApiResponse<PageStatusContestacaoResponse> localVarResponse = await ListarStatusContestacaoUsingGETAsyncWithHttpInfo(sort, page, limit, idStatusContestacao, idStatusContestacaoOrigem, descricao, flagPermiteAlteracao, flagSistema, flagAtivo);
             return localVarResponse.Data;

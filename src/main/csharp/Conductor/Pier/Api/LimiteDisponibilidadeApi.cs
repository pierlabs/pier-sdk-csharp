...
namespace Conductor.Pier.Api
{
    ...
    public interface ILimiteDisponibilidadeApi
    {
        ...
        /// <param name="dataAlteracaoInicio">Data inicial para busca de hist\u00F3ricos por per\u00EDodo (optional)</param>
        /// <param name="dataAlteracaoFim">Data final para busca de hist\u00F3ricos por per\u00EDodo (optional)</param>
    ...
    public class LimiteDisponibilidadeApi : ILimiteDisponibilidadeApi
    {
        ...
        /// <summary>
        /// Lista o hist\u00F3rico de limites Este recurso permite listar o hist\u00F3rico de limites disponibilidades
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">C\u00F3digo identificador da conta</param> 
        /// <param name="dataAlteracaoInicio">Data inicial para busca de hist\u00F3ricos por per\u00EDodo (optional)</param> 
        ...
        public ApiResponse< PagePIEROfLimiteDisponibilidadeLogResponse > ListarHistoricoAlteracoesLimitesDisponiveisWithHttpInfo (long? id, string dataAlteracaoInicio = null, string dataAlteracaoFim = null, List<string> sort = null, int? page = null, int? limit = null)
        {
            ...
            return new ApiResponse<PagePIEROfLimiteDisponibilidadeLogResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (PagePIEROfLimiteDisponibilidadeLogResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(PagePIEROfLimiteDisponibilidadeLogResponse)));

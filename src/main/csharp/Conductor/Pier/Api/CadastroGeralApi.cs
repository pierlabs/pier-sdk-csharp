...
namespace Conductor.Pier.Api
{
    ...
    public interface ICadastroGeralApi
    {
        ...
        /// <param name="dataVencimentoFim">Data final para consulta (optional)</param>
    ...
    public class CadastroGeralApi : ICadastroGeralApi
    {
        ...
        /// <summary>
        /// Alterar a previs\u00E3o de corte para o vencimento Recurso para atualizar a provis\u00E3o do corte a partir da data de vencimento
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="dataVencimento">Data Vencimento</param> 
        /// <param name="update">update</param> 
        ...
        public ApiResponse< ControleVencimentoResponse > AlterarCorteWithHttpInfo (string dataVencimento, VencimentoUpdate update, string login = null)
        {
            ...
            if (dataVencimento == null)
                throw new ApiException(400, "Missing required parameter 'dataVencimento' when calling CadastroGeralApi->AlterarCorte");
            
            // verify the required parameter 'update' is set
            if (update == null)
                throw new ApiException(400, "Missing required parameter 'update' when calling CadastroGeralApi->AlterarCorte");
        ...
        public ApiResponse< ConfiguracaoRegistroCobrancaResponse > CadastrarWithHttpInfo (ConfiguracaoRegistroCobrancaPersist configuracaoPersist)
        {
            ...
            // verify the required parameter 'configuracaoPersist' is set
            if (configuracaoPersist == null)
                throw new ApiException(400, "Missing required parameter 'configuracaoPersist' when calling CadastroGeralApi->Cadastrar");

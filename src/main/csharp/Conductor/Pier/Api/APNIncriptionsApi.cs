...
namespace Conductor.Pier.Api
{
    ...
    /// </summary>
    public interface IAPNIncriptionsApi
    {
        ...
        /// <param name="idCartoes">List of card ids on one subscription (optional)</param>
        /// <param name="page">Page (optional)</param>
        /// <param name="limit">Limit of elements per request (Default =50, Max =50) (optional)</param>
        /// <param name="deviceToken">The device token (optional)</param>
        /// <param name="dataCriacao">The subscription creation date (optional)</param>
        /// <param name="dataDesativacao">The subscription deactivation date (optional)</param>
        /// <param name="ativo">Indicates is the subscription is active (optional)</param>
        /// <param name="idAplicacaoMobile">The mobile application Id (optional)</param>
        ...
        List<InscricaoAPNResponse> Salvar (APNSubscription inscricaoPersist);
        ...
        ApiResponse<List<InscricaoAPNResponse>> SalvarWithHttpInfo (APNSubscription inscricaoPersist);
        ...
        System.Threading.Tasks.Task<List<InscricaoAPNResponse>> SalvarAsync (APNSubscription inscricaoPersist);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<InscricaoAPNResponse>>> SalvarAsyncWithHttpInfo (APNSubscription inscricaoPersist);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class APNIncriptionsApi : IAPNIncriptionsApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APNIncriptionsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public APNIncriptionsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public APNIncriptionsApi(Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Deactivate a subscription Deactivate a subscription
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">id</param> 
        /// <returns>InscricaoAPNResponse</returns>
        ...
        public ApiResponse< InscricaoAPNResponse > DesativarWithHttpInfo (long? id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling APNIncriptionsApi->Desativar");
        ...
        /// <summary>
        /// List the subscriptions List the APN subscriptions
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sort">Register ordering type (optional)</param> 
        /// <param name="idCartoes">List of card ids on one subscription (optional)</param> 
        ...
        /// <summary>
        /// Save a new subscription Save a new subscription
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="inscricaoPersist">inscricaoPersist</param> 
        /// <returns>List&lt;InscricaoAPNResponse&gt;</returns>
        public List<InscricaoAPNResponse> Salvar (APNSubscription inscricaoPersist)
        {
        ...
        /// <param name="inscricaoPersist">inscricaoPersist</param> 
        /// <returns>ApiResponse of List&lt;InscricaoAPNResponse&gt;</returns>
        public ApiResponse< List<InscricaoAPNResponse> > SalvarWithHttpInfo (APNSubscription inscricaoPersist)
        {
            
            // verify the required parameter 'inscricaoPersist' is set
            if (inscricaoPersist == null)
                throw new ApiException(400, "Missing required parameter 'inscricaoPersist' when calling APNIncriptionsApi->Salvar");
        ...
        /// <param name="inscricaoPersist">inscricaoPersist</param>
        /// <returns>Task of List&lt;InscricaoAPNResponse&gt;</returns>
        public async System.Threading.Tasks.Task<List<InscricaoAPNResponse>> SalvarAsync (APNSubscription inscricaoPersist)
        {
        ...
        /// <param name="inscricaoPersist">inscricaoPersist</param>
        /// <returns>Task of ApiResponse (List&lt;InscricaoAPNResponse&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<InscricaoAPNResponse>>> SalvarAsyncWithHttpInfo (APNSubscription inscricaoPersist)
        {
            // verify the required parameter 'inscricaoPersist' is set

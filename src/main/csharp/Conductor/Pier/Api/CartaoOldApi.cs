...
namespace Conductor.Pier.Api
{
    ...
    /// </summary>
    public interface ICartaoOldApi
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class CartaoOldApi : ICartaoOldApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CartaoOldApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CartaoOldApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CartaoOldApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< CancelarCartaoResponse > BloquearCartaoUsingPOSTWithHttpInfo (int? idConta, int? idCartao, int? motivo, string observacao = null)
        {
            ...
            if (idConta == null)
                throw new ApiException(400, "Missing required parameter 'idConta' when calling CartaoOldApi->BloquearCartaoUsingPOST");
            
            // verify the required parameter 'idCartao' is set
            if (idCartao == null)
                throw new ApiException(400, "Missing required parameter 'idCartao' when calling CartaoOldApi->BloquearCartaoUsingPOST");
            
            // verify the required parameter 'motivo' is set
            if (motivo == null)
                throw new ApiException(400, "Missing required parameter 'motivo' when calling CartaoOldApi->BloquearCartaoUsingPOST");
            
    
            var localVarPath = "/api/contas/{idConta}/cartoes/{idCartao}/bloquear";
        ...
        public ApiResponse< ConsultarCartaoResponse > ConsultarCartaoUsingGETWithHttpInfo (int? idConta, int? idCartao, string numeroCartao = null)
        {
            ...
            // verify the required parameter 'idConta' is set
            if (idConta == null)
                throw new ApiException(400, "Missing required parameter 'idConta' when calling CartaoOldApi->ConsultarCartaoUsingGET");
            
            // verify the required parameter 'idCartao' is set
            if (idCartao == null)
                throw new ApiException(400, "Missing required parameter 'idCartao' when calling CartaoOldApi->ConsultarCartaoUsingGET");
            
    
            var localVarPath = "/api/contas/{idConta}/cartoes/{idCartao}";
        ...
        public ApiResponse< ConsultarCartaoResponse > ConsultarCartoesUsingGETWithHttpInfo (int? idConta)
        {
            ...
            // verify the required parameter 'idConta' is set
            if (idConta == null)
                throw new ApiException(400, "Missing required parameter 'idConta' when calling CartaoOldApi->ConsultarCartoesUsingGET");
            
    
            var localVarPath = "/api/contas/{idConta}/cartoes";
        ...
        public ApiResponse< DesbloquearCartaoResponse > DesbloquearCartaoUsingPOSTWithHttpInfo (int? idConta, int? idCartao, string codigoSegurancao = null)
        {
            ...
            // verify the required parameter 'idConta' is set
            if (idConta == null)
                throw new ApiException(400, "Missing required parameter 'idConta' when calling CartaoOldApi->DesbloquearCartaoUsingPOST");
            
            // verify the required parameter 'idCartao' is set
            if (idCartao == null)
                throw new ApiException(400, "Missing required parameter 'idCartao' when calling CartaoOldApi->DesbloquearCartaoUsingPOST");
            
    
            var localVarPath = "/api/contas/{idConta}/cartoes/{idCartao}/desbloquear";
        ...
        public ApiResponse< EmbossadoCartaoResponse > EmbossadoCartaoUsingPUTWithHttpInfo (int? idConta, int? idCartao)
        {
            ...
            // verify the required parameter 'idConta' is set
            if (idConta == null)
                throw new ApiException(400, "Missing required parameter 'idConta' when calling CartaoOldApi->EmbossadoCartaoUsingPUT");
            
            // verify the required parameter 'idCartao' is set
            if (idCartao == null)
                throw new ApiException(400, "Missing required parameter 'idCartao' when calling CartaoOldApi->EmbossadoCartaoUsingPUT");
            
    
            var localVarPath = "/api/contas/{idConta}/cartoes/{idCartao}/embossado";

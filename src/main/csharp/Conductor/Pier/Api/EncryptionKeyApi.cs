...
namespace Conductor.Pier.Api
{
    ...
    /// </summary>
    public interface IEncryptionKeyApi
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class EncryptionKeyApi : IEncryptionKeyApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EncryptionKeyApi"/> class.
        /// </summary>
        /// <returns></returns>
        public EncryptionKeyApi(String basePath)
        {
        ...
        /// <returns></returns>
        public EncryptionKeyApi(Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Decrypts the received content This method performs the decryption of encrypted contents in the BouncyCastle pattern
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="chaveCriptografiaRequest">chaveCriptografiaRequest</param> 
        /// <returns>ChaveCriptografiaResponse</returns>
        ...
        public ApiResponse< ChaveCriptografiaResponse > DescriptografarWithHttpInfo (ChaveCriptografiaRequest chaveCriptografiaRequest)
        {
            ...
            if (chaveCriptografiaRequest == null)
                throw new ApiException(400, "Missing required parameter 'chaveCriptografiaRequest' when calling EncryptionKeyApi->Descriptografar");

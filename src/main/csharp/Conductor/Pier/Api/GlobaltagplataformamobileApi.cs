...
namespace Conductor.Pier.Api
{
    ...
    public interface IGlobaltagplataformamobileApi
    {
        ...
        /// <returns>PlataformaMobileResponse</returns>
        PlataformaMobileResponse SalvarUsingPOST22 (PlataformaMobilePersistValue persist);
        ...
        /// <param name="persist">persist</param>
        /// <returns>ApiResponse of PlataformaMobileResponse</returns>
        ApiResponse<PlataformaMobileResponse> SalvarUsingPOST22WithHttpInfo (PlataformaMobilePersistValue persist);
        ...
        /// <param name="persist">persist</param>
        /// <returns>Task of PlataformaMobileResponse</returns>
        System.Threading.Tasks.Task<PlataformaMobileResponse> SalvarUsingPOST22Async (PlataformaMobilePersistValue persist);
        ...
        /// <param name="persist">persist</param>
        /// <returns>Task of ApiResponse (PlataformaMobileResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<PlataformaMobileResponse>> SalvarUsingPOST22AsyncWithHttpInfo (PlataformaMobilePersistValue persist);
    ...
    public class GlobaltagplataformamobileApi : IGlobaltagplataformamobileApi
    {
        ...
        /// <param name="persist">persist</param> 
        /// <returns>PlataformaMobileResponse</returns>
        public PlataformaMobileResponse SalvarUsingPOST22 (PlataformaMobilePersistValue persist)
        {
             ApiResponse<PlataformaMobileResponse> localVarResponse = SalvarUsingPOST22WithHttpInfo(persist);
             return localVarResponse.Data;
        }
        ...
        /// <param name="persist">persist</param> 
        /// <returns>ApiResponse of PlataformaMobileResponse</returns>
        public ApiResponse< PlataformaMobileResponse > SalvarUsingPOST22WithHttpInfo (PlataformaMobilePersistValue persist)
        {
            
            // verify the required parameter 'persist' is set
            if (persist == null)
                throw new ApiException(400, "Missing required parameter 'persist' when calling GlobaltagplataformamobileApi->SalvarUsingPOST22");
        ...
        /// <param name="persist">persist</param>
        /// <returns>Task of PlataformaMobileResponse</returns>
        public async System.Threading.Tasks.Task<PlataformaMobileResponse> SalvarUsingPOST22Async (PlataformaMobilePersistValue persist)
        {
             ApiResponse<PlataformaMobileResponse> localVarResponse = await SalvarUsingPOST22AsyncWithHttpInfo(persist);
             return localVarResponse.Data;
        ...
        /// <param name="persist">persist</param>
        /// <returns>Task of ApiResponse (PlataformaMobileResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PlataformaMobileResponse>> SalvarUsingPOST22AsyncWithHttpInfo (PlataformaMobilePersistValue persist)
        {
            // verify the required parameter 'persist' is set

...
namespace Conductor.Pier.Api
{
    ...
    public interface ITaxaApi
    {
        ...
        /// <param name="id">Rates Id (optional)</param>
        /// <param name="idProduto">Product Id (optional)</param>
        /// <param name="dataEntrada">Entry date (optional)</param>
        /// <param name="vencimento">Expering Date (optional)</param>
    ...
    public class TaxaApi : ITaxaApi
    {
        ...
        /// <summary>
        /// List refinancing rates List refinancing rates
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sort">Register ordering type (optional)</param> 
        /// <param name="page">Page (optional)</param> 

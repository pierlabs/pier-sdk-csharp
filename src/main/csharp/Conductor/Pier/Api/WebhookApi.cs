...
namespace Conductor.Pier.Api
{
    ...
    public interface IWebhookApi
    {
        ...
        /// <param name="id">Identifier Code of the Webhook</param>
        ...
        /// </remarks>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Identification Code of the Webhook (id)</param>
        /// <returns>WebHookResponse</returns>
        ...
        /// <param name="id">Id of the WebHook (optional)</param>
        /// <param name="tipoEvento">TypeEvent to be called by the WebHook (optional)</param>
        /// <param name="metodo">Method to be called by the WebHook (optional)</param>
    ...
    public class WebhookApi : IWebhookApi
    {
        ...
        /// <summary>
        /// Update Webhook This method allows to be updated a webhook already registered
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Identifier Code of the Webhook</param> 
        /// <param name="webhook">webhook</param> 
        ...
        /// <summary>
        /// Retrieve Webhook This method allows to be retrieved a webhook of the issuer through the specific id
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Identification Code of the Webhook (id)</param> 
        /// <returns>WebHookResponse</returns>
        ...
        /// <summary>
        /// List the Webhooks This method allows to be listed the existing webhooks
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sort">Register ordering type (optional)</param> 
        /// <param name="page">Page (optional)</param> 
        ...
        /// <summary>
        /// Save Webhook This method allows to be added a new webhook
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="webhook">webhook</param> 
        /// <returns>WebHookResponse</returns>

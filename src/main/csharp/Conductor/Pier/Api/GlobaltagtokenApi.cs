...
namespace Conductor.Pier.Api
{
    ...
    /// </summary>
    public interface IGlobaltagtokenApi
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class GlobaltagtokenApi : IGlobaltagtokenApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlobaltagtokenApi"/> class.
        /// </summary>
        /// <returns></returns>
        public GlobaltagtokenApi(String basePath)
        {
        ...
        /// <returns></returns>
        public GlobaltagtokenApi(Configuration configuration = null)
        {
        ...
        /// <summary>
        /// {{{token_resource_callback}}} {{{token_resource_callback_notes}}}
        /// </summary>
        /// <exception cref="Conductor.Pier.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="bodyAccessToken">bodyAccessToken</param> 
        /// <returns>BodyAccessToken</returns>
        ...
        public ApiResponse< BodyAccessToken > CallbackUsingPOSTWithHttpInfo (BodyAccessToken bodyAccessToken)
        {
            ...
            if (bodyAccessToken == null)
                throw new ApiException(400, "Missing required parameter 'bodyAccessToken' when calling GlobaltagtokenApi->CallbackUsingPOST");

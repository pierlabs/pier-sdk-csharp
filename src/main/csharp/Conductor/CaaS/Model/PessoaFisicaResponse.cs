...
namespace Conductor.CaaS.Model
{
    ...
    /// </summary>
    [DataContract]
    public class PessoaFisicaResponse :  IEquatable<PessoaFisicaResponse>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of PessoaFisicaResponse to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Bairro != null)
                    hash = hash * 57 + this.Bairro.GetHashCode();
                
                if (this.Cep != null)
                    hash = hash * 57 + this.Cep.GetHashCode();
                
                if (this.Cidade != null)
                    hash = hash * 57 + this.Cidade.GetHashCode();
                
                if (this.ComplementoLogradouro != null)
                    hash = hash * 57 + this.ComplementoLogradouro.GetHashCode();
                
                if (this.Cpf != null)
                    hash = hash * 57 + this.Cpf.GetHashCode();
                
                if (this.DataEmissaoIdentidade != null)
                    hash = hash * 57 + this.DataEmissaoIdentidade.GetHashCode();
                
                if (this.DataNascimento != null)
                    hash = hash * 57 + this.DataNascimento.GetHashCode();
                
                if (this.Dddcelular != null)
                    hash = hash * 57 + this.Dddcelular.GetHashCode();
                
                if (this.Dddtelefone != null)
                    hash = hash * 57 + this.Dddtelefone.GetHashCode();
                
                if (this.Endereco != null)
                    hash = hash * 57 + this.Endereco.GetHashCode();
                
                if (this.IdPessoaFisica != null)
                    hash = hash * 57 + this.IdPessoaFisica.GetHashCode();
                
                if (this.Identidade != null)
                    hash = hash * 57 + this.Identidade.GetHashCode();
                
                if (this.Nome != null)
                    hash = hash * 57 + this.Nome.GetHashCode();
                
                if (this.NumeroCelular != null)
                    hash = hash * 57 + this.NumeroCelular.GetHashCode();
                
                if (this.NumeroLogradouro != null)
                    hash = hash * 57 + this.NumeroLogradouro.GetHashCode();
                
                if (this.NumeroTelefone != null)
                    hash = hash * 57 + this.NumeroTelefone.GetHashCode();
                
                if (this.OrgaoEmissor != null)
                    hash = hash * 57 + this.OrgaoEmissor.GetHashCode();
                
                if (this.Sexo != null)
                    hash = hash * 57 + this.Sexo.GetHashCode();
                
                if (this.Uf != null)
                    hash = hash * 57 + this.Uf.GetHashCode();

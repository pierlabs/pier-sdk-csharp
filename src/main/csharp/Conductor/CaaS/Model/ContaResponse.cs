...
namespace Conductor.CaaS.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ContaResponse :  IEquatable<ContaResponse>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="obj">Instance of ContaResponse to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Bin != null)
                    hash = hash * 57 + this.Bin.GetHashCode();
                
                if (this.Cartao != null)
                    hash = hash * 57 + this.Cartao.GetHashCode();
                
                if (this.DataCadastramento != null)
                    hash = hash * 57 + this.DataCadastramento.GetHashCode();
                
                if (this.DataUltimoPagamento != null)
                    hash = hash * 57 + this.DataUltimoPagamento.GetHashCode();
                
                if (this.DataVencCobranca != null)
                    hash = hash * 57 + this.DataVencCobranca.GetHashCode();
                
                if (this.DddcelularSMS != null)
                    hash = hash * 57 + this.DddcelularSMS.GetHashCode();
                
                if (this.DescricaoStatus != null)
                    hash = hash * 57 + this.DescricaoStatus.GetHashCode();
                
                if (this.DiasEmAtraso != null)
                    hash = hash * 57 + this.DiasEmAtraso.GetHashCode();
                
                if (this.Emissor != null)
                    hash = hash * 57 + this.Emissor.GetHashCode();
                
                if (this.FlagCancelamento != null)
                    hash = hash * 57 + this.FlagCancelamento.GetHashCode();
                
                if (this.FormaEnvioFatura != null)
                    hash = hash * 57 + this.FormaEnvioFatura.GetHashCode();
                
                if (this.IdBandeira != null)
                    hash = hash * 57 + this.IdBandeira.GetHashCode();
                
                if (this.IdConta != null)
                    hash = hash * 57 + this.IdConta.GetHashCode();
                
                if (this.IdEmissor != null)
                    hash = hash * 57 + this.IdEmissor.GetHashCode();
                
                if (this.IdEndereco != null)
                    hash = hash * 57 + this.IdEndereco.GetHashCode();
                
                if (this.IdFantasiaBasica != null)
                    hash = hash * 57 + this.IdFantasiaBasica.GetHashCode();
                
                if (this.IdOrigemComercial != null)
                    hash = hash * 57 + this.IdOrigemComercial.GetHashCode();
                
                if (this.IdProduto != null)
                    hash = hash * 57 + this.IdProduto.GetHashCode();
                
                if (this.IdProposta != null)
                    hash = hash * 57 + this.IdProposta.GetHashCode();
                
                if (this.MelhorDia != null)
                    hash = hash * 57 + this.MelhorDia.GetHashCode();
                
                if (this.NomeCredor != null)
                    hash = hash * 57 + this.NomeCredor.GetHashCode();
                
                if (this.NomeProduto != null)
                    hash = hash * 57 + this.NomeProduto.GetHashCode();
                
                if (this.NumCelularSMS != null)
                    hash = hash * 57 + this.NumCelularSMS.GetHashCode();
                
                if (this.Pagamentos != null)
                    hash = hash * 57 + this.Pagamentos.GetHashCode();
                
                if (this.PermiteRefinanciamento != null)
                    hash = hash * 57 + this.PermiteRefinanciamento.GetHashCode();
                
                if (this.PessoaFisica != null)
                    hash = hash * 57 + this.PessoaFisica.GetHashCode();
                
                if (this.QuantidadePagamentos != null)
                    hash = hash * 57 + this.QuantidadePagamentos.GetHashCode();
                
                if (this.SaldoLimite != null)
                    hash = hash * 57 + this.SaldoLimite.GetHashCode();
                ...
                if (this.TaxaRefinanciamento != null)
                    hash = hash * 57 + this.TaxaRefinanciamento.GetHashCode();
                
                if (this.Vcto != null)
                    hash = hash * 57 + this.Vcto.GetHashCode();
                
                if (this.Vencimento1 != null)
                    hash = hash * 57 + this.Vencimento1.GetHashCode();
                
                if (this.VinculoOrigemUsuario != null)
                    hash = hash * 57 + this.VinculoOrigemUsuario.GetHashCode();
